...
[FSP v6.6.0](https://github.com/renesas/fsp/releases/tag/v6.6.0)
...
- FSP versions of 6.5.0 and later require a minimum e² studio version of 2026-04.2.
- FSP versions of 6.6.0 and later require a minimum e² studio version of 2026-07.
...
1.	Download the FSP with e² studio Installer from the Assets section of the [current release](https://github.com/renesas/fsp/releases/tag/v6.6.0).
