...
[FSP v2.3.0](https://github.com/renesas/fsp_private/releases/tag/v2.3.0)
...
1.	Download the FSP with e² studio Installer from the Assets section of the [current release](https://github.com/renesas/fsp_private/releases/tag/v2.3.0).
