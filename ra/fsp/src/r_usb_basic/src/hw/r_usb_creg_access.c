...
{
#if USB_CFG_USE_USBIP == USB_CFG_IP0
    return USB_M0->USBREQ;
#else
    return USB_M1->USBREQ;
#endif
}
/******************************************************************************
...
{
#if USB_CFG_USE_USBIP == USB_CFG_IP0
    return USB_M0->USBVAL;
#else
    return USB_M1->USBVAL;
#endif
}
/******************************************************************************
...
{
#if USB_CFG_USE_USBIP == USB_CFG_IP0
    return USB_M0->USBINDX;
#else
    return USB_M1->USBINDX;
#endif
}
/******************************************************************************
...
{
#if USB_CFG_USE_USBIP == USB_CFG_IP0
    return USB_M0->USBLENG;
#else
    return USB_M1->USBLENG;
#endif
}
/******************************************************************************
...
{
#if USB_CFG_USE_USBIP == USB_CFG_IP0
    return USB_M0->DCPCTR;
#else
    return USB_M1->DCPCTR;
#endif
}
/******************************************************************************
