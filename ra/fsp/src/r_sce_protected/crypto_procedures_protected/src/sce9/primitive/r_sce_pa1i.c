...
fsp_err_t R_SCE_Aes256CcmEncryptInitSub(uint32_t *InData_KeyIndex, uint32_t *InData_IV, uint32_t *InData_Header, uint32_t Header_Len)
{
    uint32_t iLoop    = 0U;
    uint32_t iLoop1   = 0U;
    uint32_t iLoop2   = 0U;
    ...
    R_SCE_func101(0x4c3ac40eU, 0x3765011cU, 0xc6002113U, 0x24294fc8U);
    R_SCE_func043();
    ...
    SCE->REG_100H = change_endian_long(0x000000a1U);
    R_SCE_func101(0xb1a87a8eU, 0x6fcee1faU, 0xd614e80fU, 0x8a985a90U);
    R_SCE_func044();
...
/***********************************************************************************************************************
End of function ./input_dir/S6C1/Cryptographic/R_SCE_pa1i.prc
***********************************************************************************************************************/
