...
fsp_err_t R_SCE_Aes128CcmEncryptInitSub(uint32_t *InData_KeyIndex, uint32_t *InData_IV, uint32_t *InData_Header, uint32_t Header_Len)
{
    uint32_t iLoop    = 0U;
    uint32_t iLoop1   = 0U;
    uint32_t iLoop2   = 0U;
    ...
    R_SCE_func101(0x7c2b2869U, 0x3f284cceU, 0x6cf0923cU, 0xfbc1df1fU);
    R_SCE_func043();
    ...
    SCE->REG_100H = change_endian_long(0x00000095U);
    R_SCE_func101(0xf52e1712U, 0x4b20675bU, 0xd064589cU, 0x7e9e5ca7U);
    R_SCE_func044();
...
/***********************************************************************************************************************
End of function ./input_dir/S6C1/Cryptographic/R_SCE_p95i.prc
***********************************************************************************************************************/
