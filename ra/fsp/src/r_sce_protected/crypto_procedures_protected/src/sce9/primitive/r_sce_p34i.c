...
fsp_err_t R_SCE_Aes256GcmEncryptInitSub(uint32_t *InData_KeyIndex, uint32_t *InData_IV)
{
    ...
    R_SCE_func101(0x4e4d43a9U, 0x1e7a25d6U, 0x7b543914U, 0x44b95221U);
    R_SCE_func043();
    ...
    SCE->REG_100H = change_endian_long(0x00000034U);
    R_SCE_func101(0xb2dd72baU, 0x0454aeafU, 0xecb43d58U, 0x5d6af46fU);
    R_SCE_func044();
...
/***********************************************************************************************************************
End of function ./input_dir/S6C1/Cryptographic/R_SCE_p34i.prc
***********************************************************************************************************************/
