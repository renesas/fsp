...
fsp_err_t R_SCE_Aes256CcmDecryptInitSub(uint32_t *InData_KeyIndex, uint32_t *InData_IV, uint32_t *InData_Header, uint32_t Header_Len)
{
    uint32_t iLoop    = 0U;
    uint32_t iLoop1   = 0U;
    uint32_t iLoop2   = 0U;
    ...
    R_SCE_func101(0x5d07ed25U, 0x725def38U, 0xb64ea424U, 0x908884c7U);
    R_SCE_func043();
    ...
    SCE->REG_100H = change_endian_long(0x000000a4U);
    R_SCE_func101(0x0ba338e0U, 0xed13b463U, 0x23a14ea3U, 0x45cecd22U);
    R_SCE_func044();
...
/***********************************************************************************************************************
End of function ./input_dir/S6C1/Cryptographic/R_SCE_pa4i.prc
***********************************************************************************************************************/
