...
fsp_err_t R_SCE_Aes256GcmDecryptInitSub(uint32_t *InData_KeyIndex, uint32_t *InData_IV)
{
    ...
    R_SCE_func101(0x3b7d1401U, 0x887fe4beU, 0x3ee07ad0U, 0x82532c41U);
    R_SCE_func043();
    ...
    SCE->REG_100H = change_endian_long(0x00000036U);
    R_SCE_func101(0x3ef1c8f1U, 0xc9091cc3U, 0xd85d3f81U, 0xbacbf7b4U);
    R_SCE_func044();
...
/***********************************************************************************************************************
End of function ./input_dir/S6C1/Cryptographic/R_SCE_p36i.prc
***********************************************************************************************************************/
