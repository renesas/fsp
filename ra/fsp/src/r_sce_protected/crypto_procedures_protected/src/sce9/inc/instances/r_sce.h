...
typedef enum
{
    ...
    SCE_KEY_INDEX_TYPE_AES256 = 3U,
    SCE_KEY_INDEX_TYPE_HMAC_SHA256 = 6U,
    ...
    SCE_KEY_INDEX_TYPE_UPDATE_KEY_RING = 20U,
    SCE_KEY_INDEX_TYPE_ECC_P192_PUBLIC = 23U,
    ...
    SCE_KEY_INDEX_TYPE_ECDH_SHARED_SECRET = 37U,
    SCE_KEY_INDEX_TYPE_AES128_GCM_FOR_DLMS_COSEM = 40U,
