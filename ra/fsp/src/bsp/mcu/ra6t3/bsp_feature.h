...
#define BSP_FEATURE_BSP_HAS_USBCKDIVCR                       (1U) // On the RA6T3 there are specific registers for configuring the USB clock.
...
#define BSP_FEATURE_CAN_NUM_CHANNELS                         (0U) // RA6T3 has CAN-FD
...
#define BSP_FEATURE_CGC_HAS_SRAMPRCR2                        (1U) // On the RA6T3 there is another register to enable write access for SRAMWTSC.
...
#define BSP_FEATURE_DAC_AD_SYNC_UNIT_MASK                    (0x1U) // Mask of ADC Unit(s) that can be used for synchronization on this MCU
...
#define BSP_FEATURE_DWT_CYCCNT                               (1U)          // RA6T3 has Data Watchpoint Cycle Count Register
...
#define BSP_FEATURE_ICU_WUPEN_MASK                           (0x800780D7FFFULL) // Note there is another WUPEN1 register
...
#define BSP_FEATURE_LPM_DPSIER_MASK                          (0x05135FF3U)
