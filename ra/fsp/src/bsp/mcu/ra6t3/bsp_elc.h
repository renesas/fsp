...
typedef enum e_elc_event_ra6t3
{
    ...
    ELC_EVENT_ACMPHS1_INT            = (0x08F), // Comparator interrupt 1
    ELC_EVENT_ACMPHS2_INT            = (0x090), // Comparator interrupt 2
