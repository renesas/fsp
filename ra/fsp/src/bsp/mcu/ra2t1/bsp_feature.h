...
#define BSP_FEATURE_ACMPHS_VREF                                   ((acmphs_reference_t) 0xFF)   // The IVREF selection that corresponds to the internal voltage reference.
...
#define BSP_FEATURE_ADC_UNIT_0_CHANNELS                           (0x007807E7UL)    // Mask of available channels in ADC unit 0.
