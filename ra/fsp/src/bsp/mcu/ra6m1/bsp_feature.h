...
#define BSP_FEATURE_BSP_POWER_CHANGE_MSTP_ARRAY       {{1, 31}, {2, 5}}
...
#define BSP_FEATURE_SCI_CHANNELS                      ((1 << 0) | (1 << 1) | (1 << 2) | (1 << 3) | (1 << 4) | (1 << 8) | \
                                                       (1 << 9))
#define BSP_FEATURE_SCI_CLOCK                         (FSP_PRIV_CLOCK_PCLKA)
#define BSP_FEATURE_SCI_UART_FIFO_CHANNELS            ((1 << 0) | (1 << 1) | (1 << 2) | (1 << 3) | (1 << 4) | (1 << 8) | \
                                                       (1 << 9))
