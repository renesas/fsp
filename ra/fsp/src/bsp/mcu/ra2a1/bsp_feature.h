...
#define BSP_FEATURE_DAC8_CHANNELS_PER_UNIT                   (2)
...
#define BSP_FEATURE_DAC8_UNIT_COUNT                          (1)
...
#define BSP_FEATURE_DMAC_HAS_DMCTL                           (0U)
...
#define BSP_FEATURE_USB_HAS_USBLS_PERI                       (1U)
...
#define BSP_FEATURE_USB_REG_UCKSEL_UCKSELC                   (1U)
#define BSP_FEATURE_USB_REG_USBMC_VDCEN                      (1U)
#define BSP_FEATURE_USB_REG_USBMC_VDDUSBE                    (1U)
