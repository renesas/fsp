...
#define BSP_FEATURE_BSP_HAS_SCE_ON_S1                 (1)
...
#define BSP_FEATURE_CAN_CLOCK                         (CGC_SYSTEM_CLOCKS_ICLK)
...
#define BSP_FEATURE_CTSU_HAS_ATUNE0                   (1)
...
#define BSP_FEATURE_ELC_PERIPHERAL_MASK               (0x005CD30FU) // Positions of event link set registers (ELSRs) available on this MCU
...
#define BSP_FEATURE_FLASH_LP_CF_MACRO_SIZE            (0x40000U)                               // RA2A1 uses double access and 1 Code Flash macro of 256K for a total of 256K
...
#define BSP_FEATURE_FLASH_LP_FLASH_CF_MACROS          (1U)                                     // RA2A1 has 1 code flash HW macro
...
#define BSP_FEATURE_SCI_CHANNELS                      ((1 << 0) | (1 << 1) | (1 << 9))
#define BSP_FEATURE_SCI_CLOCK                         (FSP_PRIV_CLOCK_PCLKB)
#define BSP_FEATURE_SCI_UART_FIFO_CHANNELS            (1 << 0)
