...
#define BSP_FEATURE_ADC_CLOCK_SOURCE                      (FSP_PRIV_CLOCK_ICLK) // Clock source used for the ADC peripheral.
...
#define BSP_FEATURE_LVD_MONITOR_2_HI_THRESHOLD            ((lvd_threshold_t) 0UL)   // Typical higher bound of the detection threshold for LVD2.
#define BSP_FEATURE_LVD_MONITOR_2_LOW_THRESHOLD           ((lvd_threshold_t) 0UL)   // Typical lower bound of the detection threshold for LVD2.
...
#define BSP_FEATURE_SCI_CLOCK                             (0UL)             // Feature not available on this device.
...
#define BSP_FEATURE_SPI_CLK                               (0UL)             // Feature not available on this device.
