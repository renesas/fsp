...
#define BSP_FEATURE_ADC_CLOCK_SOURCE                         (FSP_PRIV_CLOCK_PCLKB)
#define BSP_FEATURE_ADC_D_CHANNELS                           (0x6000FF) // 0 to 7, 21 to 22 in unit 0
#define BSP_FEATURE_ADC_D_SCAN_MODE_CHANNELS                 (0x1F)
...
#define BSP_FEATURE_ADC_UNIT_0_CHANNELS                      (0) // 0 to 10, 17 to 22 in unit 0
...
#define BSP_FEATURE_AGT_VALID_CHANNEL_MASK                   (0x00)
...
#define BSP_FEATURE_BSP_HAS_FSXP_CLOCK                       (1)
...
#define BSP_FEATURE_BSP_HAS_SCE_ON_RA2                       (0)
...
#define BSP_FEATURE_BSP_MPU_REGION0_MASK                     (0)  // Feature not available on this MCU
#define BSP_FEATURE_BSP_MSTP_GPT_MSTPD5                      (0)  // Feature not available on this MCU
...
#define BSP_FEATURE_BSP_UNIQUE_ID_POINTER                    (0x01011070U)
...
#define BSP_FEATURE_CAN_CLOCK                                (0U) // Feature not available on this MCU
...
#define BSP_FEATURE_CGC_HOCOWTCR_VALUE                       (0U)
...
#define BSP_FEATURE_CGC_LOW_SPEED_SUPPORT_MAIN_OSC           (0)
...
#define BSP_FEATURE_CGC_MODRV_MASK                           (R_SYSTEM_CMC_MODRV_Msk)
#define BSP_FEATURE_CGC_MODRV_SHIFT                          (R_SYSTEM_CMC_MODRV_Pos)
#define BSP_FEATURE_CGC_OSCILLATON_STOP_DETECT               (0)  // Feature not available on this MCU
...
#define BSP_FEATURE_CGC_REGISTER_SET_B                       (1)
#define BSP_FEATURE_CGC_SCKDIVCR2_HAS_EXTRA_CLOCKS           (0)
#define BSP_FEATURE_CGC_SCKDIVCR_BCLK_MATCHES_PCLKB          (0U)
#define BSP_FEATURE_CGC_SODRV_MASK                           (0x06U)
#define BSP_FEATURE_CGC_SODRV_SHIFT                          (0x1U)
#define BSP_FEATURE_CGC_SRAMPRCR_KW_OFFSET                   (0)
#define BSP_FEATURE_CGC_SRAMPRCR_KW_VALUE                    (0x78)
#define BSP_FEATURE_CGC_STARTUP_OPCCR_MODE                   (1)
#define BSP_FEATURE_CGC_STARTUP_SCKDIVCR                     (0) // Feature not available on this MCU
#define BSP_FEATURE_CGC_STARTUP_SCKDIVCR2                    (0) // Feature not available on this MCU
#define BSP_FEATURE_CGC_STARTUP_SCKSCR                       (0) // Feature not available on this MCU

#define BSP_FEATURE_CRC_HAS_CRCCR0_LMS                       (0)
#define BSP_FEATURE_CRC_HAS_SNOOP                            (0U)
#define BSP_FEATURE_CRC_POLYNOMIAL_MASK                      (0x18U)
...
#define BSP_FEATURE_CTSU_CTSUCHAC_REGISTER_COUNT             (0U)
#define BSP_FEATURE_CTSU_CTSUCHTRC_REGISTER_COUNT            (0U)
#define BSP_FEATURE_CTSU_HAS_TXVSEL                          (0)
#define BSP_FEATURE_CTSU_VERSION                             (0)
...
#define BSP_FEATURE_DOC_VERSION                              (0U)
...
#define BSP_FEATURE_FLASH_LP_DF_BLOCK_SIZE                   (0x100U)
#define BSP_FEATURE_FLASH_LP_DF_WRITE_SIZE                   (1)
#define BSP_FEATURE_FLASH_LP_FLASH_CLOCK_SRC                 ((fsp_priv_clock_t) FSP_PRIV_CLOCK_ICLK) // Flash uses ICLK
#define BSP_FEATURE_FLASH_LP_SUPPORTS_DUAL_BANK              (0)
...
#define BSP_FEATURE_GPT_32BIT_CHANNEL_MASK                   (0U)
#define BSP_FEATURE_GPT_CLOCK_DIVIDER_STEP_SIZE              (0U)
...
#define BSP_FEATURE_ICU_HAS_FILTER                           (0U)
#define BSP_FEATURE_ICU_HAS_IELSR                            (0U)
#define BSP_FEATURE_ICU_HAS_INTERRUPT_GROUPS                 (0U)
#define BSP_FEATURE_ICU_HAS_WUPEN1                           (0)  // Feature not available on this MCU
#define BSP_FEATURE_ICU_HAS_WUPEN2                           (0)  // Feature not available on this MCU
#define BSP_FEATURE_ICU_IRQ_CHANNELS_MASK                    (0x3FU)
#define BSP_FEATURE_ICU_NMIER_MAX_INDEX                      (8U) // Max used index in NMIER
#define BSP_FEATURE_ICU_SBYEDCR_MASK                         (0x3838C1404FFULL)
#define BSP_FEATURE_ICU_WUPEN_MASK                           (0x00000000U)
...
#define BSP_FEATURE_IIC_VALID_CHANNEL_MASK                   (0x1)

#define BSP_FEATURE_IOPORT_ELC_PORTS                         (0x0006U)
#define BSP_FEATURE_IOPORT_VERSION                           (3U) // The RA0 family IOPORT periphral
...
#define BSP_FEATURE_LPM_HAS_FLASH_MODE_SELECT                (1)
#define BSP_FEATURE_LPM_HAS_HOCO_STARTUP_SPEED_MODE          (1)
...
#define BSP_FEATURE_LPM_HAS_STANDBY_SOSC_SELECT              (1)
...
#define BSP_FEATURE_LPM_SNZEDCR_MASK                         (0)
#define BSP_FEATURE_LPM_SNZREQCR_MASK                        (0U)
#define BSP_FEATURE_LPM_STANDBY_MOCO_REQUIRED                (0U)
#define BSP_FEATURE_LPM_STANDBY_MODE_CLEAR_DTCST             (1)
...
#define BSP_FEATURE_LVD_HAS_LVDLVLR                          (0)
#define BSP_FEATURE_LVD_MONITOR_1_HI_THRESHOLD               (LVD_THRESHOLD_MONITOR_1_LEVEL_4_08V) // 4.08V
#define BSP_FEATURE_LVD_MONITOR_1_LOW_THRESHOLD              (LVD_THRESHOLD_MONITOR_1_LEVEL_1_63V) // 1.63V
#define BSP_FEATURE_LVD_MONITOR_1_STABILIZATION_TIME_US      (300U)                                // LVD1 operation stabilization time after LVD1 is enabled (TBD for RA0E1)
#define BSP_FEATURE_LVD_MONITOR_2_HI_THRESHOLD               (0)                                   // Feature not available on this MCU
#define BSP_FEATURE_LVD_MONITOR_2_LOW_THRESHOLD              (0)                                   // Feature not available on this MCU
#define BSP_FEATURE_LVD_MONITOR_2_STABILIZATION_TIME_US      (0U)                                  // Feature not available on this MCU
#define BSP_FEATURE_LVD_MONITOR_MASK                         (0x01U)                               // LVD mask monitor 1
...
#define BSP_FEATURE_LVD_VERSION                              (2U)
#define BSP_FEATURE_LVD_VRTC_STABILIZATION_TIME_US           (0)                                   // Feature not available on this MCU

#define BSP_FEATURE_MACL_SUPPORTED                           (0)                                   // Feature not available on this MCU
...
#define BSP_FEATURE_POEG_CHANNEL_MASK                        (0x0U)                                // Feature not available on this MCU
...
#define BSP_FEATURE_SAU_UART_VALID_CHANNEL_MASK              (7U)

#define BSP_FEATURE_SCI_ADDRESS_MATCH_CHANNELS               (BSP_FEATURE_SCI_CHANNELS)
#define BSP_FEATURE_SCI_CHANNELS                             (0x0U)
#define BSP_FEATURE_SCI_CLOCK                                (0)  // Feature not available on this MCU
#define BSP_FEATURE_SCI_LIN_CHANNELS                         (0)  // Feature not available on this MCU
...
#define BSP_FEATURE_SCI_UART_FIFO_CHANNELS                   (0x0U)
#define BSP_FEATURE_SCI_UART_FIFO_DEPTH                      (0U)
#define BSP_FEATURE_SCI_VERSION                              (0U)
...
#define BSP_FEATURE_SPI_CLK                                  (0) // Feature not available on this MCU
...
#define BSP_FEATURE_TAU_VALID_CHANNEL_MASK                   (0x00FF)

#define BSP_FEATURE_TFU_SUPPORTED                            (0U) // Trigonometric Function Unit (TFU) not available on this MCU

#define BSP_FEATURE_TML_MAX_CLOCK_DIVIDER                    (TIMER_SOURCE_DIV_128)
#define BSP_FEATURE_TML_NUM_CHANNELS                         (4)
#define BSP_FEATURE_TML_VALID_CHANNEL_MASK                   ((1 << BSP_FEATURE_TML_NUM_CHANNELS) - 1)
...
#define BSP_FEATURE_UARTA_MSTP_OFFSET                        (0x0FU)
...
#define BSP_FEATURE_USB_HAS_USBFS                            (0U)
