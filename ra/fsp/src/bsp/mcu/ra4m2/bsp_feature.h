...
#define BSP_FEATURE_CGC_STARTUP_OPCCR_MODE                   (0) // Feature not available on this MCU TODO_CHECK_FEATURE
...
#define BSP_FEATURE_ELC_PERIPHERAL_MASK                      (0x0007F3FFU) // Positions of event link set registers (ELSRs) available on this MCU
