...
#define BSP_FEATURE_ADC_MAX_RESOLUTION_BITS                             (10UL)          // Maximum ADC resolution supported.
...
#define BSP_FEATURE_ADC_D_CHANNELS_MASK                                 (0x00600033UL)  // Mask of available channels.
#define BSP_FEATURE_ADC_D_IS_ADC12                                      (0UL)           // Specifies the ADC_D version of the ADC12 peripheral.
#define BSP_FEATURE_ADC_D_SCAN_MODE_CHANNELS_MASK                       (0x00UL)        // Mask of channels available in scan mode.
...
#define BSP_FEATURE_CGC_HAS_MOCO                                        (0UL)           // Middle clock oscillator is available.
#define BSP_FEATURE_CGC_HAS_MOSC                                        (0UL)           // Main clock oscillator is available.
...
#define BSP_FEATURE_CGC_MIDDLE_SPEED_MAX_FREQ_HZ                        (16000000UL)    // Middle speed clock maximum frequency.
#define BSP_FEATURE_CGC_MOCO_STABILIZATION_MAX_US                       (0UL)           // MOCO stabilization time in microseconds.
...
#define BSP_FEATURE_CGC_SRAMPRCR_KW_OFFSET                              (0UL)           // Bit offset for SRAMPRCR.KW field.
#define BSP_FEATURE_CGC_SRAMPRCR_KW_VALUE                               (0x00U)         // Write enable key code for SRAMPRCR bit.
...
#define BSP_FEATURE_ELC_VERSION                                         (0UL)           // Version of the ELC peripheral.
...
#define BSP_FEATURE_FLASH_LP_DF_BLOCK_SIZE                              (0x00UL)        // Block size of data flash.
#define BSP_FEATURE_FLASH_LP_DF_WRITE_SIZE                              (0x00UL)        // Write size of data flash.
...
#define BSP_FEATURE_GPT_COMPLEMENTARY_SUPPORTED                         (0UL)           // Feature not available on this device.
...
#define BSP_FEATURE_ICU_NMIER_MAX_INDEX                                 (7UL)           // Maximum bit field index of valid fields of the NMIER register.
#define BSP_FEATURE_ICU_SBYEDCR_MASK                                    (0x000000028C1404FFULL) // A mask of valid bits for [SBYEDCR1:SBYEDCR0].
...
#define BSP_FEATURE_IOPORT_ELC_PORTS_MASK                               (0x00UL)        // Mask of valid indices for ELC signal mapping of port input data.
...
#define BSP_FEATURE_SAU_UART_VALID_CHANNEL_MASK                         (0x03UL)        // Mask of valid channels for UART usage of the SAU peripheral.
