...
#define BSP_FEATURE_IIC_B_CHECK_SCL_STATUS                (1UL)             // SCL status needs to be checked before writing the transmission data in master mode.
...
#define BSP_FEATURE_IIC_BUS_FREE_TIME_MULTIPLIER          (3UL)             // Multiplication factor to calculate SDA bus free time.
