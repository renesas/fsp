...
#define BSP_FEATURE_ADC_UNIT_0_CHANNELS_MASK                      (0x00780660UL)    // Mask of available channels in ADC unit 0.
...
#define BSP_FEATURE_I3C_HAS_CLOCK                                 (0UL)             // Indicates there is a separate clock for the I3C.
...
#define BSP_FEATURE_SCI_ADDRESS_MATCH_CHANNELS_MASK               (0x0200UL)        // Mask of channels with data compare match (DCCR) available.
#define BSP_FEATURE_SCI_CHANNELS_MASK                             (0x0200UL)        // Mask of available SCI channels.
...
#define BSP_FEATURE_SCI_UART_FIFO_CHANNELS_MASK                   (0x00UL)          // Mask of channels which support the UART FIFO.
