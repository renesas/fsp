...
typedef enum e_elc_event_ra2e2
{
    ...
    ELC_EVENT_I3C0_RESPONSE          = (0xAA), // Response status buffer full
    ELC_EVENT_I3C0_COMMAND           = (0xAB), // Command buffer empty
    ELC_EVENT_I3C0_IBI               = (0xAC), // IBI status buffer full
    ELC_EVENT_I3C0_RX                = (0xAD), // Receive
    ELC_EVENT_I3C0_TX                = (0xAE), // Transmit
    ELC_EVENT_I3C0_RCV_STATUS        = (0xAF), // Receive status buffer full
    ELC_EVENT_I3C0_TEND              = (0xB4), // Transmit end
    ELC_EVENT_I3C0_EEI               = (0xB5), // Error
} elc_event_t;
