...
#define BSP_FEATURE_ADC_ADDITION_SUPPORTED                   (1U) // ADC Derived from RA8E1
...
#define BSP_FEATURE_ADC_UNIT_0_CHANNELS                      (0x001F7) // 0 to 2, 4 to 8
#define BSP_FEATURE_ADC_UNIT_1_CHANNELS                      (0x00037) // 0 to 2, 4 to 5
...
#define BSP_FEATURE_BSP_HAS_USB60_CLOCK                      (0U) // Feature available on this MCU
...
#define BSP_FEATURE_CAN_NUM_CHANNELS                         (0U) // RA8E1 has CAN-FD

#define BSP_FEATURE_CGC_EXECUTE_FROM_LOCO                    (0)
#define BSP_FEATURE_CGC_HAS_BCLK                             (1U)
#define BSP_FEATURE_CGC_HAS_CPUCLK                           (1U)
#define BSP_FEATURE_CGC_HAS_EXTRACLK2                        (0) // Feature not available on this MCU
...
#define BSP_FEATURE_CGC_HAS_SRAMPRCR2                        (0U) // On the RA8E1 there is another register to enable write access for SRAMWTSC.
...
#define BSP_FEATURE_DAC8_CHANNELS_PER_UNIT                   (0) // Feature not available on this MCU
...
#define BSP_FEATURE_DAC8_UNIT_COUNT                          (0) // Feature not available on this MCU
...
#define BSP_FEATURE_DWT_CYCCNT                               (1U) // RA8E1 has Data Watchpoint Cycle Count Register
...
#define BSP_FEATURE_FLASH_ARC_OEMBL_MAX_COUNT                (0)
...
#define BSP_FEATURE_GPT_32BIT_CHANNEL_MASK                   (0x003FU)
...
#define BSP_FEATURE_I3C_HAS_HDR_MODE                         (0U)
#define BSP_FEATURE_I3C_MAX_DEV_COUNT                        (0U)
#define BSP_FEATURE_I3C_MSTP_OFFSET                          (0U)
#define BSP_FEATURE_I3C_NTDTBP0_DEPTH                        (0U)
#define BSP_FEATURE_I3C_NUM_CHANNELS                         (0U)
...
#define BSP_FEATURE_ICU_WUPEN_MASK                           (0x00007708FB1DFFFFU) // Note there is another WUPEN1 register

#define BSP_FEATURE_IIC_BUS_FREE_TIME_MULTIPLIER             (5U)
#define BSP_FEATURE_IIC_B_CHECK_SCL_STATUS                   (0U)
#define BSP_FEATURE_IIC_B_FAST_MODE_PLUS                     (0x0)
#define BSP_FEATURE_IIC_B_VALID_CHANNEL_MASK                 (0x0)
...
#define BSP_FEATURE_LPM_DPSIER_MASK                          (0xAD1FFFFFU)
...
#define BSP_FEATURE_SDHI_HAS_CARD_DETECTION                  (0U)
...
#define BSP_FEATURE_SDHI_VALID_CHANNEL_MASK                  (0U)

#define BSP_FEATURE_SDRAM_START_ADDRESS                      (0)
...
#define BSP_FEATURE_UARTA_PCLK_RESTRICTION                   (0) // Feature not available on this MCU
