...
#define BSP_FEATURE_ADC_D_CHANNELS                                (0x00601FFFUL)    // Mask of available channels.
#define BSP_FEATURE_ADC_D_SCAN_MODE_CHANNELS                      (0x03FFUL)        // Mask of channels available in scan mode.
