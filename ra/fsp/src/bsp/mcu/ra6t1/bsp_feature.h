...
#define BSP_FEATURE_CGC_SCKDIVCR_BCLK_MATCHES_PCLKB          (1U)
...
#define BSP_FEATURE_CRYPTO_HAS_SCE7_MISSING_PROCS            (1)
...
#define BSP_FEATURE_ELC_PERIPHERAL_MASK                      (0x0003FFFFU) // Positions of event link set registers (ELSRs) available on this MCU
...
#define BSP_FEATURE_ICU_WUPEN_MASK                           (0xF04F3FFFU)
...
#define BSP_FEATURE_LPM_DPSIER_MASK                          (0x04131FF3U)
...
#define BSP_FEATURE_LPM_SNZREQCR_MASK                        (0x70423FFFU)
