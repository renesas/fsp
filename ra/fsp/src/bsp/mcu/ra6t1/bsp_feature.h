...
#define BSP_FEATURE_ICU_WUPEN_MASK                                (0xF04F3FFFULL)   // A mask of valid bits for [WUPEN1:WUPEN0].
...
#define BSP_FEATURE_LPM_DPSIER_MASK                               (0x04131FF3ULL)   // Mask of valid bit-fields of the DPSIERn registers.
...
#define BSP_FEATURE_LPM_SNZREQCR_MASK                             (0x70423FFFULL)   // Mask of valid bits for the SNZREQCRn registers.
