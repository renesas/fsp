...
#define BSP_FEATURE_ADC_UNIT_0_CHANNELS                      (0x0F)
...
#define BSP_FEATURE_BSP_HAS_SDADC_CLOCK                      (1)
...
#define BSP_FEATURE_BSP_MSTP_GPT_MSTPD5                      (0)
...
#define BSP_FEATURE_CGC_HAS_OSTDCSE                          (1)
...
#define BSP_FEATURE_CGC_HAS_PLL2                             (0U) // Feature not available on this MCU
#define BSP_FEATURE_CGC_HAS_SOPCCR                           (1U)
#define BSP_FEATURE_CGC_HAS_SOSC                             (1U)
#define BSP_FEATURE_CGC_HAS_SRAMPRCR2                        (0U) // Feature not available on this MCU
...
#define BSP_FEATURE_CGC_PLLCCR_TYPE                          (4U)
#define BSP_FEATURE_CGC_PLLCCR_VCO_MAX_HZ                    (13000000U)
...
#define BSP_FEATURE_CGC_PLL_OUT_MAX_HZ                       (12795904U)
#define BSP_FEATURE_CGC_PLL_OUT_MIN_HZ                       (11993088U)
#define BSP_FEATURE_CGC_PLL_REFERENCE_CLK_MAX_HZ             (0)
#define BSP_FEATURE_CGC_PLL_REFERENCE_CLK_MIN_HZ             (0)
#define BSP_FEATURE_CGC_PLL_SRC_MAX_HZ                       (32768U)
#define BSP_FEATURE_CGC_PLL_SRC_MIN_HZ                       (32768U)
...
#define BSP_FEATURE_CRYPTO_AES_IP_VERSION                    (2)
...
#define BSP_FEATURE_FLASH_LP_CF_DUAL_BANK_START              (0x00040000U)
...
#define BSP_FEATURE_FLASH_LP_SUPPORTS_DUAL_BANK              (1)
...
#define BSP_FEATURE_GPT_32BIT_CHANNEL_MASK                   (0U) // Feature not available on this MCU
...
#define BSP_FEATURE_ICU_FIXED_IELSR_COUNT                    (36U)
...
#define BSP_FEATURE_ICU_IRQ_CHANNELS_MASK                    (0xFFFU)
...
#define BSP_FEATURE_ICU_WUPEN_MASK                           (0x1FFFBFD0FFFULL) // Note there is another WUPEN1 register
...
#define BSP_FEATURE_IIC_VERSION                              (1)
...
#define BSP_FEATURE_LPM_RTC_REGISTER_CLOCK_DISABLE           (1U)
#define BSP_FEATURE_LPM_SBYCR_WRITE1_B14                     (0)
#define BSP_FEATURE_LPM_SNZEDCR_MASK                         (0x0000009FU)
#define BSP_FEATURE_LPM_SNZREQCR_MASK                        (0x73800FFFU)
...
#define BSP_FEATURE_LVD_EXLVD_STABILIZATION_TIME_US          (500U)                                // Time in microseconds required for EXLVD to stabilize
#define BSP_FEATURE_LVD_HAS_DIGITAL_FILTER                   (0U)
#define BSP_FEATURE_LVD_HAS_EXT_MONITOR                      (1U)
...
#define BSP_FEATURE_LVD_VBAT_STABILIZATION_TIME_US           (500U)                                // Time in microseconds required for LVD VBAT to stabilize
#define BSP_FEATURE_LVD_VERSION                              (1U)
#define BSP_FEATURE_LVD_VRTC_STABILIZATION_TIME_US           (500U)                                // Time in microseconds required for LVD VRTC to stabilize

#define BSP_FEATURE_MACL_SUPPORTED                           (1U)
...
#define BSP_FEATURE_RTC_IS_IRTC                              (1U)
...
#define BSP_FEATURE_SLCDC_CONTRAST_MAX                       (22U)
#define BSP_FEATURE_SLCDC_CONTRAST_MAX_4BIAS                 (9U)
#define BSP_FEATURE_SLCDC_HAS_8_TIME_SLICE                   (1U)
#define BSP_FEATURE_SLCDC_HAS_INTERNAL_VOLT_GEN              (1U)
#define BSP_FEATURE_SLCDC_HAS_VL1SEL                         (1U)
#define BSP_FEATURE_SLCDC_MAX_NUM_SEG                        (44U)
