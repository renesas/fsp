...
#define BSP_FEATURE_ADC_UNIT_0_CHANNELS_MASK                      (0x0FUL)          // Mask of available channels in ADC unit 0.
...
#define BSP_FEATURE_CGC_PLL_INPUT_POST_DIV_MAX_HZ                 (32768UL)         // Maximum input frequency for PLL (after input divider).
#define BSP_FEATURE_CGC_PLL_INPUT_POST_DIV_MIN_HZ                 (32768UL)         // Minimum input frequency for PLL (after input divider).
...
#define BSP_FEATURE_RTC_HAS_ALARM1                                (1UL)             // Alarm 1 is available.
