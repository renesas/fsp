...
#define BSP_FEATURE_BSP_HAS_USBCKDIVCR                       (0U) // On the RA6M5 there are specific registers for configuring the USB clock.
...
#define BSP_FEATURE_BSP_SYS_CLOCK_FREQ_THREE_ROM_WAITS       (0)          // The maximum frequency allowed without having three ROM wait cycles (Set to zero if this is not an option).
#define BSP_FEATURE_BSP_SYS_CLOCK_FREQ_TWO_ROM_WAITS         (0)          // The maximum frequency allowed without having two ROM wait cycles.
...
#define BSP_FEATURE_CAN_NUM_CHANNELS                         (0U) // RA4T1 has CAN-FD
...
#define BSP_FEATURE_CGC_HAS_SRAMPRCR2                        (1U) // On the RA64T1 there is another register to enable write access for SRAMWTSC.
...
#define BSP_FEATURE_DWT_CYCCNT                               (1U) // RA4T1 has Data Watchpoint Cycle Count Register
...
#define BSP_FEATURE_ICU_WUPEN_MASK                           (0x800700D7FFFULL) // Note there is another WUPEN1 register
...
#define BSP_FEATURE_LPM_DPSIER_MASK                          (0x04135FF3U)
...
#define BSP_FEATURE_LPM_SNZREQCR_MASK                        (0x70407FFFU)
