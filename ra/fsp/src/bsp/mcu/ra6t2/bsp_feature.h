...
#define BSP_FEATURE_ADC_B_UNIT_0_CHANNELS_MASK                          (0x000001E71FF3F03FULL) // Mask of channels available to ADC_B Unit 0.
#define BSP_FEATURE_ADC_B_UNIT_1_CHANNELS_MASK                          (0x000001E71FFC0FC0ULL) // Mask of channels available to ADC_B Unit 1.
...
#define BSP_FEATURE_GPT_AD_CONVERSION_START_CHANNEL_MASK                (0x03FFUL)      // Mask of GPT channels supporting A/D conversion start.
...
#define BSP_FEATURE_IIC_HAS_CLOCK                                       (1UL)           // Indicates there is a separate IIC clock.
...
#define BSP_FEATURE_SCI_HAS_SCISPI_CLOCK                                (1UL)           // Indicates there is a separate SCI SPI clock.
...
#define BSP_FEATURE_SCI_LIN_CHANNELS_MASK                               (0x021FUL)      // Mask of channels that can support LIN.
...
#define BSP_FEATURE_SYSC_CLOCK_FREQ_ONE_ROM_WAITS                       (120000000UL)   // Maximum frequency allowed before requiring one wait cycle.
