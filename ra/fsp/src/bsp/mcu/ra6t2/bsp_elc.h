...
typedef enum e_elc_event_ra6t2
{
    ...
    ELC_EVENT_IOPORT_EVENT_B                = (0x0B1), // DEPRECATED, do not use
    ELC_EVENT_IOPORT_EVENT_1                = (0x0B1), // Port 1 event
    ELC_EVENT_IOPORT_EVENT_C                = (0x0B2), // DEPRECATED, do not use
    ELC_EVENT_IOPORT_EVENT_2                = (0x0B2), // Port 2 event
    ELC_EVENT_IOPORT_EVENT_D                = (0x0B3), // DEPRECATED, do not use
    ELC_EVENT_IOPORT_EVENT_3                = (0x0B3), // Port 3 event
    ELC_EVENT_IOPORT_EVENT_E                = (0x0B4), // DEPRECATED, do not use
