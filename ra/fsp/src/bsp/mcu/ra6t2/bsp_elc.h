...
typedef enum e_elc_event_ra6t2
{
    ...
    ELC_EVENT_IOPORT_EVENT_B                = (0x0B1), // Port 1 event
    ELC_EVENT_IOPORT_EVENT_C                = (0x0B2), // Port 2 event
    ELC_EVENT_IOPORT_EVENT_D                = (0x0B3), // Port 3 event
    ELC_EVENT_IOPORT_EVENT_E                = (0x0B4), // Port 4 event
    ...
    ELC_EVENT_ADC0_COMPARE_MATCH            = (0x15E), // Composite compare match 0
    ...
    ELC_EVENT_ADC12_ADI5678                 = (0x169), // End of A/D scanning operation(Gr.5678)
    ...
    ELC_EVENT_ADC1_COMPARE_MATCH            = (0x16C), // Composite compare match 1
    ...
    ELC_EVENT_ADC12_FIFOREQ5678             = (0x174), // FIFO data read request interrupt(Gr.5678)
