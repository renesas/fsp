...
typedef enum e_elc_event_ra6t2
{
    ...
    ELC_EVENT_IICB0_RXI              = (0x140), // Receive data full
    ELC_EVENT_IICB0_TXI              = (0x141), // Transmit data empty
    ELC_EVENT_IICB0_TEI              = (0x142), // Transmit end
    ELC_EVENT_IICB0_ERI              = (0x143), // Transfer error
    ELC_EVENT_IICB0_WUI              = (0x144), // Slave address match
    ELC_EVENT_IICB0_COM              = (0x145), // Communication event
    ELC_EVENT_IICB1_RXI              = (0x146), // Receive data full
    ELC_EVENT_IICB1_TXI              = (0x147), // Transmit data empty
