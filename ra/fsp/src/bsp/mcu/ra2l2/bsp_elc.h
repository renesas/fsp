 ...
 * @note This list is device specific.
 * */
typedef enum e_icu_event_ra2l2
{
    ...
    ICU_EVENT_I3C0_RCV_STATUS_GROUP7        = (0x1F), // group7 (IELSR[7, 15, 23, 31])
    ...
    ICU_EVENT_SSI0_INT_GROUP3               = (0x07), // group3 (IELSR[3, 11, 19, 27])
    ICU_EVENT_SSI0_INT_GROUP7               = (0x07), // group7 (IELSR[7, 15, 23, 31])
    ICU_EVENT_SSI0_RXI_GROUP1               = (0x07), // group1 (IELSR[1, 9, 17, 25])
    ICU_EVENT_SSI0_RXI_GROUP5               = (0x07), // group5 (IELSR[5, 13, 21, 29])
    ICU_EVENT_SSI0_TXI_GROUP2               = (0x07), // group2 (IELSR[2, 10, 18, 26])
    ICU_EVENT_SSI0_TXI_GROUP6               = (0x07), // group6 (IELSR[6, 14, 22, 30])
    ICU_EVENT_TRNG_RDREQ_GROUP2             = (0x12), // group2 (IELSR[2, 10, 18, 26])
    ICU_EVENT_TRNG_RDREQ_GROUP6             = (0x12), // group6 (IELSR[6, 14, 22, 30])
    ICU_EVENT_UARTA0_ERRI_GROUP7            = (0x0D), // group7 (IELSR[7, 15, 23, 31])
    ICU_EVENT_UARTA0_RXI_GROUP0             = (0x10), // group0 (IELSR[0, 8, 16, 24])
    ICU_EVENT_UARTA0_RXI_GROUP4             = (0x10), // group4 (IELSR[4, 12, 20, 28])
    ICU_EVENT_UARTA0_TXI_GROUP2             = (0x0D), // group2 (IELSR[2, 10, 18, 26])
    ICU_EVENT_UARTA0_TXI_GROUP6             = (0x0D), // group6 (IELSR[6, 14, 22, 30])
    ICU_EVENT_UARTA1_ERRI_GROUP7            = (0x0E), // group7 (IELSR[7, 15, 23, 31])
    ICU_EVENT_UARTA1_RXI_GROUP2             = (0x1F), // group2 (IELSR[2, 10, 18, 26])
    ICU_EVENT_UARTA1_RXI_GROUP6             = (0x1F), // group6 (IELSR[6, 14, 22, 30])
    ICU_EVENT_UARTA1_TXI_GROUP1             = (0x0F), // group1 (IELSR[1, 9, 17, 25])
    ICU_EVENT_UARTA1_TXI_GROUP5             = (0x0F), // group5 (IELSR[5, 13, 21, 29])
    ICU_EVENT_USBCC_CCI_GROUP2              = (0x0E), // group2 (IELSR[2, 10, 18, 26])
    ICU_EVENT_USBCC_CCI_GROUP6              = (0x0E), // group6 (IELSR[6, 14, 22, 30])
    ICU_EVENT_USBCC_CCS_GROUP3              = (0x12), // group3 (IELSR[3, 11, 19, 27])
    ICU_EVENT_USBCC_CCS_GROUP7              = (0x12), // group7 (IELSR[7, 15, 23, 31])
    ICU_EVENT_USBFS_FIFO_0_GROUP1           = (0x16), // group1 (IELSR[1, 9, 17, 25])
    ICU_EVENT_USBFS_FIFO_0_GROUP5           = (0x16), // group5 (IELSR[5, 13, 21, 29])
    ICU_EVENT_USBFS_FIFO_1_GROUP2           = (0x1D), // group2 (IELSR[2, 10, 18, 26])
    ICU_EVENT_USBFS_FIFO_1_GROUP6           = (0x1D), // group6 (IELSR[6, 14, 22, 30])
    ICU_EVENT_USBFS_INT_GROUP0              = (0x09), // group0 (IELSR[0, 8, 16, 24])
    ICU_EVENT_USBFS_INT_GROUP4              = (0x09), // group4 (IELSR[4, 12, 20, 28])
    ICU_EVENT_USBFS_RESUME_GROUP1           = (0x09), // group1 (IELSR[1, 9, 17, 25])
    ICU_EVENT_USBFS_RESUME_GROUP5           = (0x09), // group5 (IELSR[5, 13, 21, 29])
    ...
    ICU_EVENT_SSI0_INT                      = (0x07), // DEPRECATED, do not use
    ICU_EVENT_SSI0_RXI                      = (0x07), // DEPRECATED, do not use
    ICU_EVENT_SSI0_TXI                      = (0x07), // DEPRECATED, do not use
    ICU_EVENT_TRNG_RDREQ                    = (0x12), // DEPRECATED, do not use
    ICU_EVENT_UARTA0_ERRI                   = (0x0D), // DEPRECATED, do not use
    ICU_EVENT_UARTA0_RXI                    = (0x10), // DEPRECATED, do not use
    ICU_EVENT_UARTA0_TXI                    = (0x0D), // DEPRECATED, do not use
    ICU_EVENT_UARTA1_ERRI                   = (0x0E), // DEPRECATED, do not use
    ICU_EVENT_UARTA1_RXI                    = (0x1F), // DEPRECATED, do not use
    ICU_EVENT_UARTA1_TXI                    = (0x0F), // DEPRECATED, do not use
    ICU_EVENT_USBCC_CCI                     = (0x0E), // DEPRECATED, do not use
    ICU_EVENT_USBCC_CCS                     = (0x12), // DEPRECATED, do not use
    ICU_EVENT_USBFS_FIFO_0                  = (0x16), // DEPRECATED, do not use
    ICU_EVENT_USBFS_FIFO_1                  = (0x1D), // DEPRECATED, do not use
    ICU_EVENT_USBFS_INT                     = (0x09), // DEPRECATED, do not use
    ICU_EVENT_USBFS_RESUME                  = (0x09), // DEPRECATED, do not use
