...
#define BSP_FEATURE_ADC_UNIT_0_CHANNELS_MASK                      (0x007E07FFUL)    // Mask of available channels in ADC unit 0.
...
#define BSP_FEATURE_BSP_PART_NUMBER_POINTER                       (0x01011120UL)    // Address of the Part Numbering register (PNR).
...
#define BSP_FEATURE_BSP_UNIQUE_ID_POINTER                         (0x01011110UL)    // Address of the MCU Unique ID register (UIDR).
...
#define BSP_FEATURE_ICU_WUPEN_MASK                                (0x7B0F00FFULL)   // A mask of valid bits for [WUPEN1:WUPEN0].
...
#define BSP_FEATURE_USB_HAS_TYPEC                                 (1UL)             // Supports USB-C control specifications.
