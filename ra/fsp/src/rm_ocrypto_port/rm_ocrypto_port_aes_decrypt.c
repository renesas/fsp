...
extern void ocrypto_aes_decrypt_key_schedule(uint32_t * xkey, const uint8_t * key, size_t size);
extern void ocrypto_aes_decrypt_block(uint8_t pt[16], const uint8_t ct[16], const uint32_t * xkey, size_t size);

/***********************************************************************************************************************
 * Functions
 **********************************************************************************************************************/
void ocrypto_aes_decrypt_key_schedule (uint32_t * xkey, const uint8_t * key, size_t size)
{
...
void ocrypto_aes_decrypt_block (uint8_t pt[16], const uint8_t ct[16], const uint32_t * xkey, size_t size)
{
    ...
    ocrypto_aes_helper_update(size, p_ct, p_pt, OCRYPTO_PORT_AES_BLOCK_SIZE_WORDS);
