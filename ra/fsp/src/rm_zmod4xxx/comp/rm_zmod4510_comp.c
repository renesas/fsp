...
static fsp_err_t rm_zmod4510_comp_odor_data_calculate(rm_zmod4xxx_ctrl_t * const      p_api_ctrl,
                                                      rm_zmod4xxx_raw_data_t * const  p_raw_data,
...
static fsp_err_t rm_zmod4510_comp_oaq_1st_gen_data_calculate(rm_zmod4xxx_ctrl_t * const         p_api_ctrl,
                                                             rm_zmod4xxx_raw_data_t * const     p_raw_data,
...
rm_zmod4xxx_api_t const g_zmod4xxx_on_zmod4510_comp =
{
    ...
    .odorDataCalculate         = rm_zmod4510_comp_odor_data_calculate,
    .sulfurOdorDataCalculate   = rm_zmod4510_comp_sulfur_odor_data_calculate,
    .oaq1stGenDataCalculate    = rm_zmod4510_comp_oaq_1st_gen_data_calculate,
