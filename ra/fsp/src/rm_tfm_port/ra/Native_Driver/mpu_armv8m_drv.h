 ...
 * \brief Enable MPU
 *
 * \param[in] dev            MPU device mpu_armv8m_dev_t
 ...
 *
 * \return Error code mpu_armv8m_error_t
 *
 ...
 * \param[in] dev            MPU device mpu_armv8m_dev_t
 *
 * \return Error code arm_mpu_error_t
 *
 * \note This function doesn't check if dev is NULL.
 */
 ...
 *
 * \param[in] dev            MPU device mpu_armv8m_dev_t
 * \param[in] region_cfg     MPU region config mpu_armv8m_region_cfg_t
 *
 * \return Error code arm_mpu_error_t
 *
 * \note This function doesn't check if dev is NULL.
