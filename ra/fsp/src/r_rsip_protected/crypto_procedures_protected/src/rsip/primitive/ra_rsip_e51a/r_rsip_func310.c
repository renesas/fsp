...
void r_rsip_func310(void)
{
    ...
    for (oLoop = 0; oLoop < 1024; oLoop++)
    {
        ...
        r_rsip_func100(bswap_32big(0x2eece453U), bswap_32big(0x6125f4d8U), bswap_32big(0xb74b814cU), bswap_32big(0xa399c4f3U));
        ...
        if (CHCK_STS(REG_143CH, 22U, 1U))
        {
            ...
            WR1_PROG(REG_1000H, 0x00010001U);
            WAIT_STS(REG_1000H, 0U, 0U);
            r_rsip_func101(bswap_32big(0x688c7b7aU), bswap_32big(0xf70cba72U), bswap_32big(0x6a0fc07bU), bswap_32big(0x23469096U));
        }
        else
        {
            r_rsip_func101(bswap_32big(0x8655e943U), bswap_32big(0x2c1ad69bU), bswap_32big(0x272a1d76U), bswap_32big(0xabb40233U));
        }
        ...
        r_rsip_func101(bswap_32big(0x5c64a44bU), bswap_32big(0xa3ec9fb2U), bswap_32big(0x6ced5b8dU), bswap_32big(0xf6e113e5U));
    }
