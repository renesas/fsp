...
#define RSIP_PRV_FUNC_RANDOM_NUMBER_GENERATE                     RSIP_PRV_FUNC_NAME_RANDOM_NUMBER_GENERATE
 ...
 #define RSIP_PRV_FUNC_KEY_PAIR_GENERATE_ECC_EDWARDS25519          RSIP_PRV_FUNC_NAME_KEY_PAIR_GENERATE_ECC_EDWARDS25519
...
const rsip_func_key_pair_generate_t gp_func_key_pair_generate_ecc[RSIP_KEY_ECC_NUM] =
{
    ...
    [RSIP_KEY_ECC_EDWARDS25519]    = RSIP_PRV_FUNC_KEY_PAIR_GENERATE_ECC_EDWARDS25519
};
...
const rsip_func_encrypted_key_wrap_t gp_func_encrypted_key_wrap_ecc_pub[RSIP_KEY_ECC_NUM] =
{
    ...
    [RSIP_KEY_ECC_EDWARDS25519]    = RSIP_PRV_FUNC_ENC_KEY_WRAP_ECC_EDWARDS25519_PUBLIC
};
...
const rsip_func_encrypted_key_wrap_t gp_func_encrypted_key_wrap_ecc_priv[RSIP_KEY_ECC_NUM] =
{
    ...
    [RSIP_KEY_ECC_EDWARDS25519]    = RSIP_PRV_FUNC_ENC_KEY_WRAP_ECC_EDWARDS25519_PRIVATE
};
...
const rsip_func_eddsa_sign_t gp_func_eddsa_sign[RSIP_KEY_ECC_NUM] =
{
    [RSIP_KEY_ECC_EDWARDS25519] = RSIP_PRV_FUNC_EDDSA_SIGN_EDWARDS25519,
};

const rsip_func_eddsa_verify_t gp_func_eddsa_verify[RSIP_KEY_ECC_NUM] =
{
    [RSIP_KEY_ECC_EDWARDS25519] = RSIP_PRV_FUNC_EDDSA_VERIFY_EDWARDS25519,
};

const rsip_func_ecdh_t gp_func_ecdh_wrapped[RSIP_KEY_ECC_NUM] =
{
    [RSIP_KEY_ECC_SECP256R1] = RSIP_PRV_FUNC_ECDH_WRAPPED_SECP256R1,
    [RSIP_KEY_ECC_SECP384R1] = RSIP_PRV_FUNC_ECDH_WRAPPED_SECP384R1,
    [RSIP_KEY_ECC_SECP521R1] = RSIP_PRV_FUNC_ECDH_WRAPPED_SECP521R1
};

const rsip_func_ecdh_t gp_func_ecdh_plain[RSIP_KEY_ECC_NUM] =
{
    [RSIP_KEY_ECC_SECP256R1] = RSIP_PRV_FUNC_ECDH_PLAIN_SECP256R1,
    [RSIP_KEY_ECC_SECP384R1] = RSIP_PRV_FUNC_ECDH_PLAIN_SECP384R1,
    [RSIP_KEY_ECC_SECP521R1] = RSIP_PRV_FUNC_ECDH_PLAIN_SECP521R1
};
...
const rsip_func_pki_cert_key_import_t gp_func_pki_cert_key_import_ecc[RSIP_KEY_ECC_NUM] =
{
    ...
    [RSIP_KEY_ECC_SECP384R1] = RSIP_PRV_FUNC_PKI_CERT_KEY_IMPORT_ECC_SECP384R1,
    [RSIP_KEY_ECC_SECP521R1] = RSIP_PRV_FUNC_PKI_CERT_KEY_IMPORT_ECC_SECP521R1
};
...
const rsip_func_kdf_ecdh_secret_msg_wrap_t gp_func_kdf_sha_ecdh_secret_msg_wrap[RSIP_DKM_SUBTYPE_SHA_NUM] =
{
    [RSIP_DKM_SUBTYPE_SHA_256] = RSIP_PRV_FUNC_KDF_SHA_ECDH_SECRET_MSG_WRAP_SHA256,
};

const rsip_func_kdf_derived_key_import_t gp_func_kdf_sha_derived_key_import_aes[RSIP_DKM_SUBTYPE_SHA_NUM][
    RSIP_KEY_AES_NUM] =
{
    [RSIP_DKM_SUBTYPE_SHA_256][RSIP_KEY_AES_128] = RSIP_PRV_FUNC_KDF_SHA_DERIVED_KEY_IMPORT_SHA256_AES_128,
    [RSIP_DKM_SUBTYPE_SHA_256][RSIP_KEY_AES_256] = RSIP_PRV_FUNC_KDF_SHA_DERIVED_KEY_IMPORT_SHA256_AES_256,
};

const rsip_func_kdf_derived_iv_wrap_t gp_func_kdf_sha_derived_iv_wrap[RSIP_DKM_SUBTYPE_SHA_NUM][2] =
{
    [RSIP_DKM_SUBTYPE_SHA_256][RSIP_INITIAL_VECTOR_TYPE_AES_16_BYTE] = RSIP_PRV_FUNC_KDF_SHA_DERIVED_IV_WRAP_SHA256_AES,
};
...
const rsip_func_kdf_ecdh_secret_key_import_t gp_func_kdf_ecdh_secret_key_import[RSIP_KEY_KDF_HMAC_NUM] =
{
    ...
    [RSIP_KEY_KDF_HMAC_SHA384] = RSIP_PRV_FUNC_KDF_ECDH_SECRET_KEY_IMPORT_SHA384,
    [RSIP_KEY_KDF_HMAC_SHA512] = RSIP_PRV_FUNC_KDF_ECDH_SECRET_KEY_IMPORT_SHA512
};
...
const rsip_func_kdf_ecdh_secret_msg_wrap_t gp_func_kdf_ecdh_secret_msg_wrap[RSIP_KEY_KDF_HMAC_NUM] =
{
    ...
    [RSIP_KEY_KDF_HMAC_SHA384] = RSIP_PRV_FUNC_KDF_ECDH_SECRET_MSG_WRAP_SHA384,
    [RSIP_KEY_KDF_HMAC_SHA512] = RSIP_PRV_FUNC_KDF_ECDH_SECRET_MSG_WRAP_SHA512
};
...
const rsip_func_kdf_mac_key_import_t gp_func_kdf_mac_key_import[RSIP_KEY_KDF_HMAC_NUM] =
{
    ...
    [RSIP_KEY_KDF_HMAC_SHA384] = RSIP_PRV_FUNC_KDF_MAC_KEY_IMPORT_SHA384,
    [RSIP_KEY_KDF_HMAC_SHA512] = RSIP_PRV_FUNC_KDF_MAC_KEY_IMPORT_SHA512
};
...
const rsip_func_kdf_derived_key_import_t gp_func_kdf_derived_key_import_aes[RSIP_KEY_KDF_HMAC_NUM][RSIP_KEY_AES_NUM] =
{
    ...
    [RSIP_KEY_KDF_HMAC_SHA384][RSIP_KEY_AES_128] = RSIP_PRV_FUNC_KDF_DERIVED_KEY_IMPORT_SHA384_AES_128,
    [RSIP_KEY_KDF_HMAC_SHA384][RSIP_KEY_AES_256] = RSIP_PRV_FUNC_KDF_DERIVED_KEY_IMPORT_SHA384_AES_256,
    [RSIP_KEY_KDF_HMAC_SHA512][RSIP_KEY_AES_128] = RSIP_PRV_FUNC_KDF_DERIVED_KEY_IMPORT_SHA512_AES_128,
    [RSIP_KEY_KDF_HMAC_SHA512][RSIP_KEY_AES_256] = RSIP_PRV_FUNC_KDF_DERIVED_KEY_IMPORT_SHA512_AES_256
};
...
const rsip_func_kdf_derived_key_import_t gp_func_kdf_derived_key_import_hmac[RSIP_KEY_KDF_HMAC_NUM][RSIP_KEY_HMAC_NUM] =
{
    ...
    [RSIP_KEY_KDF_HMAC_SHA256][RSIP_KEY_HMAC_SHA384] = RSIP_PRV_FUNC_KDF_DERIVED_KEY_IMPORT_SHA256_HMAC_SHA384,
    [RSIP_KEY_KDF_HMAC_SHA256][RSIP_KEY_HMAC_SHA512] = RSIP_PRV_FUNC_KDF_DERIVED_KEY_IMPORT_SHA256_HMAC_SHA512,
    [RSIP_KEY_KDF_HMAC_SHA384][RSIP_KEY_HMAC_SHA256] = RSIP_PRV_FUNC_KDF_DERIVED_KEY_IMPORT_SHA384_HMAC_SHA256,
    [RSIP_KEY_KDF_HMAC_SHA384][RSIP_KEY_HMAC_SHA384] = RSIP_PRV_FUNC_KDF_DERIVED_KEY_IMPORT_SHA384_HMAC_SHA384,
    [RSIP_KEY_KDF_HMAC_SHA384][RSIP_KEY_HMAC_SHA512] = RSIP_PRV_FUNC_KDF_DERIVED_KEY_IMPORT_SHA384_HMAC_SHA512,
    [RSIP_KEY_KDF_HMAC_SHA512][RSIP_KEY_HMAC_SHA256] = RSIP_PRV_FUNC_KDF_DERIVED_KEY_IMPORT_SHA512_HMAC_SHA256,
    [RSIP_KEY_KDF_HMAC_SHA512][RSIP_KEY_HMAC_SHA384] = RSIP_PRV_FUNC_KDF_DERIVED_KEY_IMPORT_SHA512_HMAC_SHA384,
    [RSIP_KEY_KDF_HMAC_SHA512][RSIP_KEY_HMAC_SHA512] = RSIP_PRV_FUNC_KDF_DERIVED_KEY_IMPORT_SHA512_HMAC_SHA512
};
...
const rsip_func_kdf_derived_iv_wrap_t gp_func_kdf_derived_iv_wrap[RSIP_KEY_KDF_HMAC_NUM][2] =
{
    ...
    [RSIP_KEY_KDF_HMAC_SHA384][RSIP_INITIAL_VECTOR_TYPE_AES_16_BYTE] = RSIP_PRV_FUNC_KDF_DERIVED_IV_WRAP_SHA384_AES,
    [RSIP_KEY_KDF_HMAC_SHA512][RSIP_INITIAL_VECTOR_TYPE_AES_16_BYTE] = RSIP_PRV_FUNC_KDF_DERIVED_IV_WRAP_SHA512_AES,
};
