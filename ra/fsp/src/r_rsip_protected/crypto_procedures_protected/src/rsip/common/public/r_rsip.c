...
static const uint32_t gs_wrapped_key_value_len_hmac[RSIP_KEY_HMAC_NUM] =
{
    ...
    [RSIP_KEY_HMAC_SHA384] = RSIP_CFG_BYTE_SIZE_WRAPPED_KEY_VALUE_HMAC_SHA384,
    [RSIP_KEY_HMAC_SHA512] = RSIP_CFG_BYTE_SIZE_WRAPPED_KEY_VALUE_HMAC_SHA512,
};
 ...
 * - @ref RSIP_KEY_PAIR_TYPE_ECC_SECP256R1, @ref RSIP_KEY_PAIR_TYPE_ECC_SECP384R1, @ref RSIP_KEY_PAIR_TYPE_ECC_SECP521R1,
 * - @ref RSIP_KEY_PAIR_TYPE_ECC_SECP256K1,
 * - @ref RSIP_KEY_PAIR_TYPE_ECC_BRAINPOOLP256R1, @ref RSIP_KEY_PAIR_TYPE_ECC_BRAINPOOLP384R1, @ref RSIP_KEY_PAIR_TYPE_ECC_BRAINPOOLP512R1,
 * - @ref RSIP_KEY_PAIR_TYPE_RSA_2048, @ref RSIP_KEY_PAIR_TYPE_RSA_3072, @ref RSIP_KEY_PAIR_TYPE_RSA_4096
 *
 * @par State transition
 * This API can only be executed in **STATE_MAIN**, and does not cause any state transitions.
 *
