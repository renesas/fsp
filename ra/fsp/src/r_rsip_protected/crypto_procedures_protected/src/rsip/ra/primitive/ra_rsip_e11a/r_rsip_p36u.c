...
void r_rsip_p36u (const uint32_t InData_Text[], uint32_t OutData_Text[], uint32_t MAX_CNT)
{
    ...
    r_rsip_func100(bswap_32big(0x4a0f828cU),
                   bswap_32big(0x4d763817U),
                   bswap_32big(0xb99344e9U),
                   bswap_32big(0x7fbb2d88U));
    ...
    r_rsip_func101(bswap_32big(0xba5d4c1bU),
                   bswap_32big(0x383d3965U),
                   bswap_32big(0x47f765fdU),
                   bswap_32big(0x72bbbe05U));
}
