...
void r_rsip_func314(void)
{
    ...
    while (1)
    {
        ...
        r_rsip_func100(bswap_32big(0x5dc4167fU), bswap_32big(0xdfa0e3b1U), bswap_32big(0x3d212490U), bswap_32big(0xb10bdaaeU));
        ...
        if (CHCK_STS(REG_143CH, 22U, 1U))
        {
            ...
            WR1_PROG(REG_1608H, 0x00000080U);
            WR1_PROG(REG_143CH, 0x00260000U);
            r_rsip_func100(bswap_32big(0x500a3648U), bswap_32big(0x385aed6bU), bswap_32big(0x17e3088cU), bswap_32big(0xc61537c4U));
            WR1_PROG(REG_143CH, 0x00400000U);
            if (CHCK_STS(REG_143CH, 22U, 1U))
            {
                ...
                WAIT_STS(REG_1404H, 30U, 0U);
                WR1_PROG(REG_143CH, 0x00001800U);
                r_rsip_func101(bswap_32big(0xa0c648b5U), bswap_32big(0x1f9a33f2U), bswap_32big(0x13985f0cU), bswap_32big(0x50f12c36U));
            }
            else
            {
                ...
                r_rsip_func101(bswap_32big(0x06210c5dU), bswap_32big(0x8d0c5b27U), bswap_32big(0x4c1a9e53U), bswap_32big(0x604435feU));
                r_rsip_func317();
                WR1_PROG(REG_1404H, 0x17680000U);
                WR1_PROG(REG_1608H, 0x800102e0U);
                WR1_PROG(REG_1400H, 0x00030005U);
                ...
                WR1_PROG(REG_1420H, bswap_32big(0x0000f314U));
                WR1_PROG(REG_1458H, 0x00000000U);
                r_rsip_func101(bswap_32big(0xf2711aa0U), bswap_32big(0x5dffa914U), bswap_32big(0x619fc2a3U), bswap_32big(0x17082dcbU));
                ...
                WR1_PROG(REG_1420H, bswap_32big(0x0000f314U));
                WR1_PROG(REG_1458H, 0x00000000U);
                r_rsip_func101(bswap_32big(0x578e3a3bU), bswap_32big(0x1149611eU), bswap_32big(0x817ba55fU), bswap_32big(0x43d449d0U));
                r_rsip_func318();
                WR1_PROG(REG_1404H, 0x17680000U);
                WR1_PROG(REG_1608H, 0x800102e0U);
                WR1_PROG(REG_1400H, 0x00030005U);
                ...
                WAIT_STS(REG_1404H, 30U, 0U);
                WR1_PROG(REG_143CH, 0x00001800U);
                r_rsip_func101(bswap_32big(0x50ba135fU), bswap_32big(0x781953f9U), bswap_32big(0xf05b8d42U), bswap_32big(0xbc2c9d9dU));
            }
        }
        else
        {
            r_rsip_func101(bswap_32big(0xb4a0384fU), bswap_32big(0xcd3cd70fU), bswap_32big(0xad73a83cU), bswap_32big(0xd9e13823U));
            break;
        }
    }
