                        ...
                        uint32_t       OutData_MAC[])
{
    ...
    if (CHCK_STS(REG_143CH, 22, 1))
    {
        ...
        {
            r_rsip_func100(bswap_32big(0x90ed49e7U), bswap_32big(0x098bd813U), bswap_32big(0xa6d6f145U), bswap_32big(0x235ebf98U));
            WR1_PROG(REG_1408H, 0x00004032U);
            WAIT_STS(REG_1408H, 30, 1);
            RD12_ADDR(REG_1420H, &OutData_MAC[0]);

            r_rsip_func102(bswap_32big(0x352f38c8U), bswap_32big(0xee4e235fU), bswap_32big(0xd2dbdcb1U), bswap_32big(0xc84455c8U));
            WR1_PROG(REG_14BCH, 0x00000040U);
            WAIT_STS(REG_142CH, 12, 0);
        }
        else if (RD1_MASK(REG_1440H, 0xffffffffU) == 0x00000006U)
        {
            r_rsip_func100(bswap_32big(0x4a510798U), bswap_32big(0xfc029359U), bswap_32big(0x290d7027U), bswap_32big(0xf32f787aU));
            WR1_PROG(REG_1408H, 0x00004042U);
            WAIT_STS(REG_1408H, 30, 1);
            RD16_ADDR(REG_1420H, &OutData_MAC[0]);

            r_rsip_func102(bswap_32big(0xc15fdafaU), bswap_32big(0x628a9928U), bswap_32big(0x29f19258U), bswap_32big(0x4e26e728U));
            WR1_PROG(REG_14BCH, 0x00000040U);
            WAIT_STS(REG_142CH, 12, 0);
        }
    ...
    {
        r_rsip_func100(bswap_32big(0x935beb89U), bswap_32big(0x093d4062U), bswap_32big(0xf3193d07U), bswap_32big(0x377e81c4U));
        ...
        if (RD1_MASK(REG_1440H, 0xffffffffU) == 0x00000001U)
        {
            ...
            r_rsip_func101(bswap_32big(0x39248654U), bswap_32big(0x2b2ead69U), bswap_32big(0x51bf0030U), bswap_32big(0x0af1a03cU));
        }
        else if (RD1_MASK(REG_1440H, 0xffffffffU) == 0x00000002U)
        {
            WR1_PROG(REG_1600H, 0x0000b440U);
            ...
            r_rsip_func101(bswap_32big(0x015e4f5eU), bswap_32big(0x93ac7d35U), bswap_32big(0x505b42c2U), bswap_32big(0xe78a74abU));
        }
        else if (RD1_MASK(REG_1440H, 0xffffffffU) == 0x00000005U)
        {
            WR1_PROG(REG_1600H, 0x0000b440U);
            ...
            r_rsip_func101(bswap_32big(0x0f420d9cU), bswap_32big(0x67696037U), bswap_32big(0xa556cea6U), bswap_32big(0xf938003dU));
        }
        else if (RD1_MASK(REG_1440H, 0xffffffffU) == 0x00000006U)
        {
            WR1_PROG(REG_1600H, 0x0000b440U);
            ...
            r_rsip_func101(bswap_32big(0x445b7f11U), bswap_32big(0x7dfda686U), bswap_32big(0xd59d7715U), bswap_32big(0x0c6b8496U));
        }
        ...
        {
            r_rsip_func100(bswap_32big(0x8baea9e4U), bswap_32big(0x7d429282U), bswap_32big(0x074aeb80U), bswap_32big(0xbe27aba0U));
            ...
            {
                r_rsip_func100(bswap_32big(0xda719471U), bswap_32big(0x7b6e23daU), bswap_32big(0x84d9cf3bU), bswap_32big(0x9e8619abU));
                ...
                if (RD1_MASK(REG_1440H, 0xffffffffU) == 0x00000000U)
                {
                    ...
                    r_rsip_func101(bswap_32big(0x29f7ab0aU), bswap_32big(0xad41feb8U), bswap_32big(0x65713280U), bswap_32big(0xfd39715eU));
                }
                else
                {
                    ...
                    r_rsip_func101(bswap_32big(0x771de06aU), bswap_32big(0x427323c3U), bswap_32big(0x5f6f85f0U), bswap_32big(0x57bd697cU));
                }
                ...
                r_rsip_func101(bswap_32big(0x298e2ab0U), bswap_32big(0x9a2d1b27U), bswap_32big(0xec3c2ceaU), bswap_32big(0xd524cbf6U));
                iLoop = iLoop + 4U;
            }
            ...
            r_rsip_func100(bswap_32big(0xaf6f5e67U), bswap_32big(0x773f2216U), bswap_32big(0x094b1d18U), bswap_32big(0x8548d3f2U));
            WR1_PROG(REG_143CH, 0x00400000U);

            if (CHCK_STS(REG_143CH, 22, 1))
            {
                r_rsip_func102(bswap_32big(0x252b31a1U), bswap_32big(0x91cc3fbfU), bswap_32big(0x7447417eU), bswap_32big(0x435514d4U));
                WR1_PROG(REG_14BCH, 0x00000040U);
                WAIT_STS(REG_142CH, 12, 0);
            ...
            {
                r_rsip_func102(bswap_32big(0x5b1ad2ecU), bswap_32big(0x7e0c8e9cU), bswap_32big(0x85adf7f4U), bswap_32big(0xe831d6deU));
                WR1_PROG(REG_14BCH, 0x00000040U);
                WAIT_STS(REG_142CH, 12, 0);
