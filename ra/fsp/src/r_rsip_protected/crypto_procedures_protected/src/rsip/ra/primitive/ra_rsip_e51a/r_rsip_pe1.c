                       ...
                       uint32_t       OutData_KeyIndex[])
{
    ...
    r_rsip_func100(bswap_32big(0xe5f859edU), bswap_32big(0x53931fd1U), bswap_32big(0x637e9996U), bswap_32big(0xd1d925beU));
    WR1_PROG(REG_143CH, 0x00400000U);

    if (CHCK_STS(REG_143CH, 22, 1))
    {
        r_rsip_func102(bswap_32big(0x16dedb43U), bswap_32big(0x20dd646eU), bswap_32big(0x00a1a904U), bswap_32big(0x958fcf49U));
    ...
    else
    {
        ...
        r_rsip_func100(bswap_32big(0x83d70f4aU), bswap_32big(0x3915f1c7U), bswap_32big(0x37aa821dU), bswap_32big(0xc7bd81c4U));
        ...
        r_rsip_func101(bswap_32big(0x5e4bcd2aU), bswap_32big(0x63e05642U), bswap_32big(0x9d5a0a47U), bswap_32big(0x042ab940U));
        r_rsip_func043();
        ...
        r_rsip_func101(bswap_32big(0xc9540137U), bswap_32big(0xd995ff31U), bswap_32big(0xb0a7cf4eU), bswap_32big(0xc2e287a6U));
        r_rsip_func044();
        ...
        for (iLoop = 0U; iLoop < S_RAM[0]; )
        {
            ...
            r_rsip_func101(bswap_32big(0xe6724a0dU), bswap_32big(0x45c62eb2U), bswap_32big(0x2c607da4U), bswap_32big(0x92de6debU));
            iLoop = iLoop + 4U;
        }
        WR1_PROG(REG_1458H, 0x00000000U);
        ...
        r_rsip_func100(bswap_32big(0xbf71ef6cU), bswap_32big(0xff5c0fdbU), bswap_32big(0xc76f6c8bU), bswap_32big(0x4a4ebcfcU));
        WR1_PROG(REG_143CH, 0x00400000U);

        if (CHCK_STS(REG_143CH, 22, 1))
        {
            r_rsip_func102(bswap_32big(0xab87a1a5U), bswap_32big(0xf5e9b4b2U), bswap_32big(0x4265aa06U), bswap_32big(0x0db6f774U));
            WR1_PROG(REG_14BCH, 0x00000040U);
            WAIT_STS(REG_142CH, 12, 0);
        ...
        {
            r_rsip_func100(bswap_32big(0x436c46d0U), bswap_32big(0x2232724dU), bswap_32big(0xc21ccbedU), bswap_32big(0x98124919U));
            ...
            if (RD1_MASK(REG_1440H, 0xffffffffU) == 0x00000003U)
            {
                ...
                r_rsip_func101(bswap_32big(0xda4b6533U), bswap_32big(0x1c025110U), bswap_32big(0x71e2cbd4U), bswap_32big(0x2c58a25cU));
            }
            ...
            else if (RD1_MASK(REG_1440H, 0xffffffffU) == 0x00000005U)
            {
                ...
                r_rsip_func101(bswap_32big(0x4ed62bbbU), bswap_32big(0x688da3d5U), bswap_32big(0x69411f6eU), bswap_32big(0x8fcb96adU));
            }
            ...
            r_rsip_func100(bswap_32big(0x210dd939U), bswap_32big(0xa6fa5d65U), bswap_32big(0xf8e493c7U), bswap_32big(0x7ce6069dU));
            WR1_PROG(REG_143CH, 0x00400000U);

            if (CHCK_STS(REG_143CH, 22, 1))
            {
                r_rsip_func102(bswap_32big(0xd6b295b5U), bswap_32big(0x3ad60ee7U), bswap_32big(0xdbcd1aa8U), bswap_32big(0xd614eb62U));
                WR1_PROG(REG_14BCH, 0x00000040U);
                WAIT_STS(REG_142CH, 12, 0);
            ...
            {
                r_rsip_func100(bswap_32big(0x73486254U), bswap_32big(0xbbf45fa9U), bswap_32big(0xc0f6e844U), bswap_32big(0xb505eb78U));
                WR1_PROG(REG_1600H, 0x00000800U);
                ...
                r_rsip_func100(bswap_32big(0xf6fb9f58U), bswap_32big(0x27c206bdU), bswap_32big(0x80d37382U), bswap_32big(0x2a4bb405U));
                ...
                for (iLoop = 0U; iLoop < S_RAM[0]; )
                {
                    ...
                    r_rsip_func101(bswap_32big(0x4ca9e6c5U), bswap_32big(0xe7815412U), bswap_32big(0xfaa581e6U), bswap_32big(0x7bdc5bb4U));
                    iLoop = iLoop + 4U;
                }
                WR1_PROG(REG_1458H, 0x00000000U);

                r_rsip_func100(bswap_32big(0xa3a2237bU), bswap_32big(0x0255990cU), bswap_32big(0x5c95da1cU), bswap_32big(0x89730260U));
                ...
                for (iLoop = iTemp; iLoop < S_RAM[0]; iLoop++)
                {
                    ...
                    for (jLoop = 0U; jLoop < 4; jLoop++)
                    {
                        ...
                        r_rsip_func100(bswap_32big(0xd7cd7b1bU), bswap_32big(0xc193483eU), bswap_32big(0xf9aa9cf8U), bswap_32big(0xb860ae74U));
                        WR1_PROG(REG_143CH, 0x00400000U);
                        ...
                        if (CHCK_STS(REG_143CH, 22, 1))
                        {
                            ...
                            r_rsip_func101(bswap_32big(0x2de13bf2U), bswap_32big(0x2301380bU), bswap_32big(0xdeef4966U), bswap_32big(0x6ea2cf50U));
                        }
                        ...
                        r_rsip_func100(bswap_32big(0xd35ad9b2U), bswap_32big(0xb83f554dU), bswap_32big(0xcd8096b0U), bswap_32big(0x680eb5afU));
                        WR1_PROG(REG_143CH, 0x00400000U);
                        ...
                        if (CHCK_STS(REG_143CH, 22, 1))
                        {
                            ...
                            r_rsip_func101(bswap_32big(0x89cf42a5U), bswap_32big(0x1db03debU), bswap_32big(0x70d34219U), bswap_32big(0x7f6514d1U));
                        }
                        ...
                        r_rsip_func100(bswap_32big(0x23a8a71dU), bswap_32big(0xa33043d8U), bswap_32big(0x942d1c09U), bswap_32big(0x38fc3a44U));
                        WR1_PROG(REG_143CH, 0x00400000U);
                        ...
                        if (CHCK_STS(REG_143CH, 22, 1))
                        {
                            ...
                            r_rsip_func101(bswap_32big(0x106a1855U), bswap_32big(0x2c84008fU), bswap_32big(0x2f7114bcU), bswap_32big(0xa3aa0502U));
                        }

                        WR1_PROG(REG_1600H, 0x00002c40U);

                        r_rsip_func101(bswap_32big(0xdd5098a9U), bswap_32big(0xcdf89368U), bswap_32big(0x5c8beeb2U), bswap_32big(0x5ec4ecc9U));
                    }
                    WR1_PROG(REG_1458H, 0x00000000U);
                    ...
                    r_rsip_func101(bswap_32big(0xe304a236U), bswap_32big(0xcfc87fbdU), bswap_32big(0x1c697c4cU), bswap_32big(0x7f2d6214U));
                }
                WR1_PROG(REG_1458H, 0x00000000U);
                ...
                r_rsip_func100(bswap_32big(0x4b3a5963U), bswap_32big(0xade90730U), bswap_32big(0xf3f2200cU), bswap_32big(0xf0f4cd82U));
                WR1_PROG(REG_1600H, 0x00003416U);
                ...
                for (iLoop = 0U; iLoop < S_RAM[0]; iLoop++)
                {
                    ...
                    r_rsip_func101(bswap_32big(0xd9c8773eU), bswap_32big(0x715d13dcU), bswap_32big(0xa3718a88U), bswap_32big(0x72d67ac0U));
                }
                WR1_PROG(REG_1458H, 0x00000000U);
                ...
                r_rsip_func100(bswap_32big(0x877f9088U), bswap_32big(0x72e44acbU), bswap_32big(0xfe563c0dU), bswap_32big(0xddc1d601U));
                WR1_PROG(REG_1608H, 0x81010200U);
                WR1_PROG(REG_1408H, 0x00005006U);
                WAIT_STS(REG_1408H, 30, 1);
                RD1_ADDR(REG_1420H, &S_RAM[0]);
                ...
                for (iLoop = 0U; iLoop < S_RAM[0]; iLoop++)
                {
                    ...
                    r_rsip_func101(bswap_32big(0xaab0dd0bU), bswap_32big(0x47b20ff5U), bswap_32big(0x426b7c2eU), bswap_32big(0xba5ed4cbU));
                }
                WR1_PROG(REG_1458H, 0x00000000U);
                ...
                r_rsip_func100(bswap_32big(0x67e4d98eU), bswap_32big(0x61f29891U), bswap_32big(0x212764d3U), bswap_32big(0x5c7d3fcbU));
                WR1_PROG(REG_143CH, 0x00400000U);

                if (CHCK_STS(REG_143CH, 22, 1))
                {
                    r_rsip_func102(bswap_32big(0xac65695fU), bswap_32big(0x4744d87dU), bswap_32big(0x312610d1U), bswap_32big(0x0bf34fefU));
                    WR1_PROG(REG_14BCH, 0x00000040U);
                    WAIT_STS(REG_142CH, 12, 0);
                ...
                else
                {
                    ...
                    r_rsip_func100(bswap_32big(0x9c9ae4eeU), bswap_32big(0xe9a63f5bU), bswap_32big(0x1635412aU), bswap_32big(0x1f00e4f2U));
                    WR1_PROG(REG_143CH, 0x00400000U);
                    ...
                    if (CHCK_STS(REG_143CH, 22, 1))
                    {
                        ...
                        r_rsip_func101(bswap_32big(0xd76b2013U), bswap_32big(0x3ff4463cU), bswap_32big(0x336f2d0aU), bswap_32big(0x89661fc2U));
                    }

                    r_rsip_func100(bswap_32big(0xe036adb4U), bswap_32big(0x47548ea6U), bswap_32big(0x2a310af5U), bswap_32big(0xb68e219aU));
                    r_rsip_func103();
                    ...
                    r_rsip_func101(bswap_32big(0x0a5d6e21U), bswap_32big(0x0e472016U), bswap_32big(0x99abada3U), bswap_32big(0x702dd666U));
                    r_rsip_func043();
