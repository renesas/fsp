...
void r_rsip_func311(void)
{
    ...
    while (1)
    {
        ...
        r_rsip_func100(bswap_32big(0x6c3f5059U), bswap_32big(0xc0742058U), bswap_32big(0x72caad39U), bswap_32big(0xcf4dc557U));
        ...
        if (CHCK_STS(REG_143CH, 22U, 1U))
        {
            ...
            WR1_PROG(REG_1000H, 0x00010001U);
            WAIT_STS(REG_1000H, 0U, 0U);
            r_rsip_func101(bswap_32big(0xf065cebbU), bswap_32big(0xb4a2e3ceU), bswap_32big(0x22713327U), bswap_32big(0x0a5a29a7U));
        }
        else
        {
            WR1_PROG(REG_1014H, 0x00000b68U);
            ...
            r_rsip_func100(bswap_32big(0x9233eb27U), bswap_32big(0xb080aa8aU), bswap_32big(0x4f2e9fbeU), bswap_32big(0x62b0be4fU));
            WR1_PROG(REG_143CH, 0x00400000U);
            if (CHCK_STS(REG_143CH, 22U, 1U))
            {
                ...
                WR1_PROG(REG_1608H, 0x00000080U);
                WR1_PROG(REG_143CH, 0x00A60000U);
                r_rsip_func100(bswap_32big(0x41cb113bU), bswap_32big(0xc311954fU), bswap_32big(0x2411cb1aU), bswap_32big(0xcce1c8a9U));
                WR1_PROG(REG_143CH, 0x00400000U);
                if (CHCK_STS(REG_143CH, 22U, 1U))
                {
                    ...
                    WR1_PROG(REG_1000H, 0x00010001U);
                    WAIT_STS(REG_1000H, 0U, 0U);
                    r_rsip_func101(bswap_32big(0xd97d7079U), bswap_32big(0xece70de5U), bswap_32big(0x88c3762eU), bswap_32big(0xe1ed94fdU));
                }
                else
                {
                    ...
                    WR1_PROG(REG_1608H, 0x00000080U);
                    WR1_PROG(REG_143CH, 0x00260000U);
                    r_rsip_func100(bswap_32big(0x28f035e2U), bswap_32big(0x2acfbfc5U), bswap_32big(0x82581072U), bswap_32big(0xc4691dd6U));
                    WR1_PROG(REG_143CH, 0x00400000U);
                    if (CHCK_STS(REG_143CH, 22U, 1U))
                    {
                        WR1_PROG(REG_1014H, 0x00000948U);
                        ...
                        WR1_PROG(REG_1608H, 0x00000080U);
                        WR1_PROG(REG_143CH, 0x00A60000U);
                        r_rsip_func100(bswap_32big(0x61607ae2U), bswap_32big(0xcac66caeU), bswap_32big(0x15336fe6U), bswap_32big(0x125a931bU));
                        WR1_PROG(REG_143CH, 0x00400000U);
                        if (CHCK_STS(REG_143CH, 22U, 1U))
                        {
                            r_rsip_func101(bswap_32big(0x612561b1U), bswap_32big(0x69a6b19aU), bswap_32big(0xb89806e3U), bswap_32big(0xecaba86aU));
                            break;
                        }
                        else
                        {
                            ...
                            WR1_PROG(REG_1000H, 0x00010001U);
                            WAIT_STS(REG_1000H, 0U, 0U);
                            r_rsip_func101(bswap_32big(0xcdeaef1eU), bswap_32big(0xc960fb74U), bswap_32big(0x69ae4e67U), bswap_32big(0xfd8d1626U));
                        }
                    }
                    else
                    {
                        ...
                        WR1_PROG(REG_1608H, 0x00000080U);
                        WR1_PROG(REG_143CH, 0x00260000U);
                        r_rsip_func100(bswap_32big(0x2b1a9745U), bswap_32big(0xd5150c15U), bswap_32big(0xcd8ab433U), bswap_32big(0x432e8cd7U));
                        WR1_PROG(REG_143CH, 0x00400000U);
                        if (CHCK_STS(REG_143CH, 22U, 1U))
                        {
                            r_rsip_func101(bswap_32big(0x0684953fU), bswap_32big(0x4ff4772aU), bswap_32big(0xdb4046e8U), bswap_32big(0xeed45ea7U));
                            break;
                        }
                        else
                        {
                            ...
                            WR1_PROG(REG_1000H, 0x00010001U);
                            WAIT_STS(REG_1000H, 0U, 0U);
                            r_rsip_func101(bswap_32big(0xd03bebfaU), bswap_32big(0x248a6525U), bswap_32big(0x5de0f709U), bswap_32big(0x6183dfe7U));
                        }
                    }
                }
            }
            else
            {
                ...
                WR1_PROG(REG_1000H, 0x00010001U);
                WAIT_STS(REG_1000H, 0U, 0U);
                r_rsip_func101(bswap_32big(0x2d4d6fecU), bswap_32big(0x5332f872U), bswap_32big(0xeb3db6dcU), bswap_32big(0x2099468eU));
            }
        }
    }
    WR1_PROG(REG_1014H, 0x00000948U);
