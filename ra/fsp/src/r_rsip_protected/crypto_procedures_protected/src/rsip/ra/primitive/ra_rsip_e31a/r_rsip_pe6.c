                       ...
                       uint32_t       OutData_KeyIndex[])
{
    ...
    else
    {
        ...
        WR1_PROG(REG_0094H, 0x300030a0U);
        ...
        else
        {
            ...
            WR1_PROG(REG_0094H, 0x00003cc1U);
            ...
            for (iLoop = 0U; iLoop < S_RAM[0]; iLoop++)
            {
                ...
                WAIT_STS(REG_0014H, 31, 1);
                WR1_PROG(REG_002CH, bswap_32big(0x0000e601U));
                WR1_PROG(REG_0024H, 0x00000000U);
                ...
                WR1_PROG(REG_0094H, 0x380008e2U);
                WR1_PROG(REG_009CH, 0x00000080U);
                WR1_PROG(REG_0040H, 0x00270000U);
            ...
            WR1_PROG(REG_0094H, 0x38000805U);
            WR1_PROG(REG_009CH, 0x00000080U);
            WR1_PROG(REG_0040H, 0x00270000U);
            WR1_PROG(REG_0040H, 0x00402000U);
            ...
            else
            {
                WR1_PROG(REG_0094H, 0x0000b420U);
                WR1_PROG(REG_0094H, 0x00000010U);
                WR1_PROG(REG_0094H, 0x000038a1U);
                ...
                WR1_PROG(REG_009CH, 0x800100e0U);
                WAIT_STS(REG_0014H, 31, 1);
                WR1_PROG(REG_002CH, bswap_32big(0x0000e602U));
                WR1_PROG(REG_0024H, 0x00000000U);
                ...
                if (CHCK_STS(REG_0040H, 22, 1))
                {
                    ...
                    WR1_PROG(REG_009CH, 0x80880007U);
                ...
                WR1_PROG(REG_0094H, 0x0000b460U);
                WR1_PROG(REG_0094H, 0x00000040U);
                WR1_PROG(REG_0094H, 0x00002865U);

                WR1_PROG(REG_0094H, 0x00000884U);

                WR1_PROG(REG_0094H, 0x00003425U);
                ...
                WR1_PROG(REG_0094H, 0x38000883U);
                WR1_PROG(REG_009CH, 0x00000080U);
                WR1_PROG(REG_0040H, 0x00270000U);
                WR1_PROG(REG_0040H, 0x00402000U);
