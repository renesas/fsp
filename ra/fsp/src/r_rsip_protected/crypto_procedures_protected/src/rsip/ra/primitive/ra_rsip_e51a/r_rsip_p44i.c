...
rsip_ret_t r_rsip_p44i (const uint32_t InData_KeyIndex[])
{
    ...
    r_rsip_func101(bswap_32big(0x0016cdbbU), bswap_32big(0xfadbbf30U), bswap_32big(0x68feffbcU), bswap_32big(0xdc3d84acU));
    r_rsip_func043();
    ...
    r_rsip_func101(bswap_32big(0x1f80c1b8U), bswap_32big(0x00d55f14U), bswap_32big(0xf7b6feffU), bswap_32big(0x82d89836U));
    r_rsip_func044();
