...
{
    r_rsip_func100(bswap_32big(0x85e2aebeU), bswap_32big(0x98480a19U), bswap_32big(0xffcf0a19U), bswap_32big(0x4eb8c805U));
    ...
    r_rsip_func100(bswap_32big(0x24fa535aU), bswap_32big(0x33c4841dU), bswap_32big(0x567dacccU), bswap_32big(0x475ab5a9U));
    WR1_PROG(REG_1A24H, 0x08000095U);
    WR1_PROG(REG_1400H, 0x00890011U);
    WAIT_STS(REG_1404H, 30, 0);
    WR1_PROG(REG_143CH, 0x00001800U);

    r_rsip_func100(bswap_32big(0x9cef12b2U), bswap_32big(0x31d8c68fU), bswap_32big(0x94279a36U), bswap_32big(0xbda605daU));
