                       ...
                       uint32_t       MAX_CNT)
{
    ...
    r_rsip_func100(bswap_32big(0x884c6cc2U),
                   bswap_32big(0xad7ac1d8U),
                   bswap_32big(0x0fa3a069U),
                   bswap_32big(0x645802deU));
    ...
    r_rsip_func100(bswap_32big(0x269eb2e5U),
                   bswap_32big(0xae126f7bU),
                   bswap_32big(0xa2d05a81U),
                   bswap_32big(0xe9200ea6U));
    WR1_PROG(REG_0008H, 0x00001012U);
    WAIT_STS(REG_0008H, 30, 1);
    RD4_ADDR(REG_002CH, &OutData_DataT[0]);

    r_rsip_func102(bswap_32big(0xe734b9b5U),
                   bswap_32big(0xfbded4b2U),
                   bswap_32big(0x3747d485U),
                   bswap_32big(0x16b28389U));
