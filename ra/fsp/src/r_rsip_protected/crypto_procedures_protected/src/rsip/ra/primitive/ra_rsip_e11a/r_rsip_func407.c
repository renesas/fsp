...
{
    r_rsip_func_sub013(0x00003407U, 0x800100c0U);
    WR1_PROG(REG_002CH, ARG1[0]);
    WR1_PROG(REG_0024H, 0x00000000U);

    r_rsip_func_sub002(0x800100e0U, 0x0000f407U);

    r_rsip_func101(bswap_32big(0xcadf706bU),
                   bswap_32big(0x4a86eb9dU),
                   bswap_32big(0x4554efe7U),
                   bswap_32big(0x0b30d4c6U));
    r_rsip_func043();
    ...
    r_rsip_func101(bswap_32big(0x660a411dU),
                   bswap_32big(0xd1e5357bU),
                   bswap_32big(0x2148dd79U),
                   bswap_32big(0xc21fe373U));
    r_rsip_func044();
