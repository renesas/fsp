                       ...
                       const uint32_t InData_DomainParam[])
{
    ...
    else
    {
        ...
        r_rsip_func100(bswap_32big(0xd0702932U), bswap_32big(0x67ebeff0U), bswap_32big(0xd9a33228U), bswap_32big(0xf8cfc189U));
        WR1_PROG(REG_143CH, 0x00400000U);
        ...
        if (CHCK_STS(REG_143CH, 22, 1))
        {
            ...
            r_rsip_func101(bswap_32big(0xaae76fecU), bswap_32big(0xddbd1d83U), bswap_32big(0x58986dacU), bswap_32big(0x3724e93bU));
        }
        else
        {
            r_rsip_func100(bswap_32big(0x302f4ccfU), bswap_32big(0x369a3af5U), bswap_32big(0x959cb153U), bswap_32big(0x4632d664U));
            ...
            r_rsip_func100(bswap_32big(0xc0401041U), bswap_32big(0x8a4ba88bU), bswap_32big(0x6d3c7918U), bswap_32big(0x4fb8407fU));
            ...
            r_rsip_func100(bswap_32big(0xdc151ea5U), bswap_32big(0x190d8560U), bswap_32big(0x936bb66fU), bswap_32big(0x3766db0aU));
            WR1_PROG(REG_143CH, 0x00400000U);
            ...
            if (CHCK_STS(REG_143CH, 22, 1))
            {
                ...
                r_rsip_func101(bswap_32big(0xf1fe4625U), bswap_32big(0xbc007e74U), bswap_32big(0x19fd1bfdU), bswap_32big(0xdd83e8c3U));
            }
            else
            {
                WR1_PROG(REG_1014H, 0x00000b60U);
                ...
                r_rsip_func101(bswap_32big(0x245a8d17U), bswap_32big(0x8ae1d93fU), bswap_32big(0x55ff9c00U), bswap_32big(0x2dde1392U));
            }
            ...
            for (iLoop = 0U; iLoop < 12U; iLoop++)
            {
                ...
                for (jLoop = 0U; jLoop < 32U; jLoop++)
                {
                    ...
                    r_rsip_func100(bswap_32big(0x78488daeU), bswap_32big(0xa33ce35aU), bswap_32big(0x9c7e3896U), bswap_32big(0xcf165b32U));
                    WR1_PROG(REG_143CH, 0x00400000U);
                    ...
                    if (CHCK_STS(REG_143CH, 22, 1))
                    {
                        ...
                        r_rsip_func101(bswap_32big(0x5904743eU), bswap_32big(0xc53b5d4aU), bswap_32big(0x28eeaf58U), bswap_32big(0x11663c56U));
                    }
                    else
                    {
                        r_rsip_func101(bswap_32big(0x1eb9f769U), bswap_32big(0xb418bd5dU), bswap_32big(0x5dd5ea57U), bswap_32big(0x3b5b332cU));
                    }
                    WR1_PROG(REG_1458H, 0x00000000U);
                    ...
                    r_rsip_func100(bswap_32big(0x2d76c0acU), bswap_32big(0x7618c9fcU), bswap_32big(0x2d91762eU), bswap_32big(0x85d4f3c9U));
                    WR1_PROG(REG_143CH, 0x00400000U);

                    if (CHCK_STS(REG_143CH, 22, 1))
                    {
                        r_rsip_func100(bswap_32big(0x458705ccU), bswap_32big(0xe267b315U), bswap_32big(0xb4015c58U), bswap_32big(0x958400bcU));
                        ...
                        if (RD1_MASK(REG_1440H, 0xffffffffU) == 0x00000001U)
                        {
                            ...
                            r_rsip_func101(bswap_32big(0x17b5d499U), bswap_32big(0xfac09d37U), bswap_32big(0x19e9bfdeU), bswap_32big(0x5952342aU));
                        }
                        else if (RD1_MASK(REG_1440H, 0xffffffffU) == 0x00000002U)
                        {
                            ...
                            r_rsip_func101(bswap_32big(0xc0042aa1U), bswap_32big(0xdd9fb291U), bswap_32big(0xa275e87dU), bswap_32big(0xebec268dU));
                        }
                        else if (RD1_MASK(REG_1440H, 0xffffffffU) == 0x00000003U)
                        {
                            ...
                            r_rsip_func101(bswap_32big(0x307ebf99U), bswap_32big(0xcd78573eU), bswap_32big(0x698afb3eU), bswap_32big(0x0ed028cfU));
                        }
                        ...
                        r_rsip_func100(bswap_32big(0x6a073adaU), bswap_32big(0x43a0cfadU), bswap_32big(0x32c49c78U), bswap_32big(0xf38d2e41U));
                        WR1_PROG(REG_143CH, 0x00400000U);
                        ...
                        if (CHCK_STS(REG_143CH, 22, 1))
                        {
                            ...
                            r_rsip_func100(bswap_32big(0x17fc605aU), bswap_32big(0x28a89aabU), bswap_32big(0x1425ac1fU), bswap_32big(0x1fd898a5U));
                            WR1_PROG(REG_143CH, 0x00400000U);
                            ...
                            if (CHCK_STS(REG_143CH, 22, 1))
                            {
                                ...
                                r_rsip_func100(bswap_32big(0xe822ea65U), bswap_32big(0x254610d6U), bswap_32big(0x93efde2eU), bswap_32big(0xf7f525bfU));
                                WR1_PROG(REG_143CH, 0x00400000U);
                                ...
                                if (CHCK_STS(REG_143CH, 22, 1))
                                {
                                    ...
                                    r_rsip_func101(bswap_32big(0x17bbf529U), bswap_32big(0x0c73b7caU), bswap_32big(0x68fceefcU), bswap_32big(0xa0e4585dU));
                                }
                                else
                                {
                                    WR1_PROG(REG_1014H, 0x00000250U);
                                    ...
                                    r_rsip_func101(bswap_32big(0x5c601e67U), bswap_32big(0xab91835bU), bswap_32big(0xf7500dd1U), bswap_32big(0x4c0721ccU));
                                }
                            }
                            else
                            {
                                r_rsip_func101(bswap_32big(0xaea03807U), bswap_32big(0x49514dadU), bswap_32big(0xe1045737U), bswap_32big(0xe97504a5U));
                            }
                        }
                        else
                        {
                            ...
                            r_rsip_func101(bswap_32big(0xa9feff43U), bswap_32big(0x77d772dfU), bswap_32big(0xd5697b9cU), bswap_32big(0x3dd5bec1U));
                        }
                    }
                    else
                    {
                        r_rsip_func101(bswap_32big(0x74f4c842U), bswap_32big(0x6b55e0d5U), bswap_32big(0x3ab7e5e0U), bswap_32big(0x2e581b0fU));
                    }

                    WR1_PROG(REG_1600H, 0x00002c40U);
                    r_rsip_func101(bswap_32big(0x58661d5cU), bswap_32big(0x307b56d8U), bswap_32big(0x3840358bU), bswap_32big(0x951d0d3aU));
                }
                ...
                r_rsip_func101(bswap_32big(0x054d23b7U), bswap_32big(0x1a639893U), bswap_32big(0x52a47e89U), bswap_32big(0x17199521U));
            }
            ...
            r_rsip_func100(bswap_32big(0xd9b9f22cU), bswap_32big(0xb2a5026cU), bswap_32big(0xffba9197U), bswap_32big(0x02c27a15U));
            WR1_PROG(REG_143CH, 0x00400000U);
            ...
            if (CHCK_STS(REG_143CH, 22, 1))
            {
                ...
                r_rsip_func101(bswap_32big(0xa26c9c9cU), bswap_32big(0x579ded4aU), bswap_32big(0x13041f6eU), bswap_32big(0xae04a268U));
            }
            else
            {
                r_rsip_func100(bswap_32big(0x68d243dbU), bswap_32big(0x81864761U), bswap_32big(0xd34296afU), bswap_32big(0xca5ba0fdU));
                ...
                r_rsip_func100(bswap_32big(0x396ab264U), bswap_32big(0xa4b4bcdaU), bswap_32big(0x33643a68U), bswap_32big(0x549ea493U));
                WR1_PROG(REG_143CH, 0x00400000U);
                ...
                if (CHCK_STS(REG_143CH, 22, 1))
                {
                    ...
                    r_rsip_func101(bswap_32big(0x8b2bb26dU), bswap_32big(0x5de6c6ceU), bswap_32big(0x0fbe8043U), bswap_32big(0x28650794U));
                }
                else
                {
                    ...
                    r_rsip_func101(bswap_32big(0x8d92baa8U), bswap_32big(0xfbd58e93U), bswap_32big(0xa600c8caU), bswap_32big(0x22c2e085U));
                }
            }
        }
