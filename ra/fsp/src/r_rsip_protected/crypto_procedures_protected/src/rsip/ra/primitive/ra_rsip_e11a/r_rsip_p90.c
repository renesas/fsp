...
rsip_ret_t r_rsip_p90 (const uint32_t InData_Cmd[], const uint32_t InData_KeyIndex[], const uint32_t InData_WrappedKeyType[], const uint32_t InData_Text[], uint32_t OutData_KeyIndex[])
{
    uint32_t iLoop = 0U;
    int32_t  jLoop = 0U;
    ...
    r_rsip_func100(bswap_32big(0x00014046U), bswap_32big(0x9f4d276dU), bswap_32big(0x4025a588U), bswap_32big(0x7e7147a3U));
    WR1_PROG(REG_0040H, 0x00400000U);
    WR1_PROG(REG_0024H, 0x00000000U);

    if (CHCK_STS(REG_0040H, 22, 1))
    {
        r_rsip_func102(bswap_32big(0x2f74a54dU), bswap_32big(0x29126b48U), bswap_32big(0x63187731U), bswap_32big(0x73bb1014U));
    ...
    else
    {
        ...
        r_rsip_func101(bswap_32big(0xb4503a91U), bswap_32big(0xbb351276U), bswap_32big(0x4e41639fU), bswap_32big(0x185a64bfU));
        r_rsip_func043();
        ...
        r_rsip_func101(bswap_32big(0x72cf367fU), bswap_32big(0x6ce48394U), bswap_32big(0x65109ed7U), bswap_32big(0x3e25e84dU));
        r_rsip_func044();
        ...
        r_rsip_func100(bswap_32big(0xfc43242bU), bswap_32big(0x898f9d41U), bswap_32big(0xbb187193U), bswap_32big(0xbbfd2a1bU));
        WR1_PROG(REG_0040H, 0x00400000U);
        WR1_PROG(REG_0024H, 0x00000000U);

        if (CHCK_STS(REG_0040H, 22, 1))
        {
            r_rsip_func100(bswap_32big(0xe1e9dbf2U), bswap_32big(0xf6336579U), bswap_32big(0xae7315dbU), bswap_32big(0xe214cc3aU));
            ...
            r_rsip_func101(bswap_32big(0x2f755422U), bswap_32big(0x1143393aU), bswap_32big(0x480041a4U), bswap_32big(0x0a2611bdU));
        }
        else
        {
            r_rsip_func100(bswap_32big(0x27fadf3fU), bswap_32big(0x01a8c474U), bswap_32big(0x96df87e9U), bswap_32big(0xc5eedb1dU));
            ...
            r_rsip_func100(bswap_32big(0xc63d5ddfU), bswap_32big(0x579f86b7U), bswap_32big(0xa0e8e3a6U), bswap_32big(0xb68c1035U));
            ...
            r_rsip_func101(bswap_32big(0xcae485d3U), bswap_32big(0x6c9c7b24U), bswap_32big(0x33f0253aU), bswap_32big(0x7c956eafU));
        }

        r_rsip_func100(bswap_32big(0xdf6c721bU), bswap_32big(0x459ecad6U), bswap_32big(0x09647fe1U), bswap_32big(0xfada669cU));
        WR1_PROG(REG_0040H, 0x00400000U);
        WR1_PROG(REG_0024H, 0x00000000U);

        if (CHCK_STS(REG_0040H, 22, 1))
        {
            r_rsip_func102(bswap_32big(0xa61ca121U), bswap_32big(0xd0f8d815U), bswap_32big(0x9996d866U), bswap_32big(0x2284e80aU));
            WR1_PROG(REG_006CH, 0x00000040U);
            WAIT_STS(REG_0020H, 12, 0);
        ...
        else
        {
            ...
            for (iLoop = 2; iLoop < WRAPPED_KEY_SIZE; )
            {
                ...
                r_rsip_func101(bswap_32big(0x143b45ecU), bswap_32big(0xd0e1b81fU), bswap_32big(0x6beb14b3U), bswap_32big(0xe9ec3c67U));
                iLoop = iLoop + 2;
            }
            ...
            for (jLoop = 5; jLoop >= 0; jLoop = jLoop - 1)
            {
                ...
                for (iLoop = (WRAPPED_KEY_SIZE / 2) - 1; iLoop >= 1; iLoop = iLoop - 1)
                {
                    ...
                    r_rsip_func101(bswap_32big(0xc232f32dU), bswap_32big(0x84747eabU), bswap_32big(0xcbb2b5b4U), bswap_32big(0xfa96e8a8U));
                }
                ...
                r_rsip_func101(bswap_32big(0x8a239735U), bswap_32big(0xccc0343bU), bswap_32big(0xb35704f0U), bswap_32big(0x9c9c21f3U));
            }
            ...
            r_rsip_func100(bswap_32big(0x843a96b4U), bswap_32big(0xd4bdef13U), bswap_32big(0xbe59b4d7U), bswap_32big(0xa5f221f7U));
            WR1_PROG(REG_0040H, 0x00400000U);
            WR1_PROG(REG_0024H, 0x00000000U);

            if (CHCK_STS(REG_0040H, 22, 1))
            {
                r_rsip_func102(bswap_32big(0x852cd333U), bswap_32big(0x5cf1eea8U), bswap_32big(0x7a724b27U), bswap_32big(0xce8b6148U));
                WR1_PROG(REG_006CH, 0x00000040U);
                WAIT_STS(REG_0020H, 12, 0);
            ...
            {
                r_rsip_func100(bswap_32big(0xd6579601U), bswap_32big(0x68ff4a7dU), bswap_32big(0x2d789293U), bswap_32big(0x8f5c7227U));
                ...
                r_rsip_func101(bswap_32big(0x246188b2U), bswap_32big(0x9f67715bU), bswap_32big(0x03e5b027U), bswap_32big(0x985e5ddaU));
                r_rsip_func043();
                ...
                r_rsip_func101(bswap_32big(0x2d33ce77U), bswap_32big(0x623d7cdbU), bswap_32big(0xa1f4ba36U), bswap_32big(0x66f1b667U));
                r_rsip_func044();
                ...
                for (iLoop = 0U; iLoop < KEY_INDEX_SIZE - 5; )
                {
                    ...
                    r_rsip_func100(bswap_32big(0xe2fb211eU), bswap_32big(0x004c04f1U), bswap_32big(0x04d03c84U), bswap_32big(0x48c51eb2U));
                    WR1_PROG(REG_00D4H, 0x40000000U);
                    ...
                    r_rsip_func101(bswap_32big(0x4745ee6aU), bswap_32big(0x9c6aecaaU), bswap_32big(0x47a820afU), bswap_32big(0x93ac1fa3U));
                    iLoop = iLoop + 4U;
                }
                ...
                r_rsip_func100(bswap_32big(0xd010b531U), bswap_32big(0x86456ec0U), bswap_32big(0x2e21dea2U), bswap_32big(0xa9c2b85bU));
                WR1_PROG(REG_0014H, 0x000000a1U);
                WR1_PROG(REG_00D0H, 0x0c000104U);
                WAIT_STS(REG_0014H, 31, 1);
                WR1_PROG(REG_002CH, bswap_32big(0x00000000U));
                ...
                r_rsip_func100(bswap_32big(0x76e65c2aU), bswap_32big(0x7690067eU), bswap_32big(0x0c706a81U), bswap_32big(0x961acbb1U));
                WR1_PROG(REG_009CH, 0x81010000U);
                WR1_PROG(REG_0008H, 0x00005006U);
                WAIT_STS(REG_0008H, 30, 1);
                RD1_ADDR(REG_002CH, &OutData_KeyIndex[0]);

                r_rsip_func102(bswap_32big(0x38025114U), bswap_32big(0xe8dbaa13U), bswap_32big(0x502d3f4eU), bswap_32big(0x958849fdU));
                WR1_PROG(REG_006CH, 0x00000040U);
                WAIT_STS(REG_0020H, 12, 0);
