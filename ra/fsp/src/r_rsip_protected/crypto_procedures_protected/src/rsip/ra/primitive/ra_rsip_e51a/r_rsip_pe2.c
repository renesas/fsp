                       ...
                       uint32_t       OutData_EncSecret[])
{
    ...
    r_rsip_func100(bswap_32big(0x328269e9U), bswap_32big(0xc8ee4358U), bswap_32big(0x78796ef9U), bswap_32big(0xa359d29fU));
    ...
    r_rsip_func101(bswap_32big(0x88c5b650U), bswap_32big(0xd717472eU), bswap_32big(0x9abf85b9U), bswap_32big(0x47bdc2c4U));
    r_rsip_func043();
    ...
    else
    {
        ...
        r_rsip_func100(bswap_32big(0x28acf91aU), bswap_32big(0x3d0b2c86U), bswap_32big(0x3d8d9d07U), bswap_32big(0xe170dc69U));
        WR1_PROG(REG_143CH, 0x00400000U);
        ...
        if (CHCK_STS(REG_143CH, 22, 1))
        {
            ...
            r_rsip_func101(bswap_32big(0x0760abfbU), bswap_32big(0x6d259365U), bswap_32big(0x92002191U), bswap_32big(0x19fa1835U));
        }
        else
        {
            WR1_PROG(REG_1444H, 0x000000c7U);
            ...
            r_rsip_func101(bswap_32big(0xf8451663U), bswap_32big(0x0d90a12dU), bswap_32big(0xabf0cbe6U), bswap_32big(0xe645e16bU));
            r_rsip_func043();
        ...
        r_rsip_func100(bswap_32big(0x5e180cffU), bswap_32big(0x7c600a29U), bswap_32big(0xa2e7e0d9U), bswap_32big(0xc5bf4914U));
        WR1_PROG(REG_143CH, 0x00400000U);

        if (CHCK_STS(REG_143CH, 22, 1))
        {
            r_rsip_func102(bswap_32big(0xfd64a6a4U), bswap_32big(0x549a39d2U), bswap_32big(0xd6d1554aU), bswap_32big(0xce100a75U));
            WR1_PROG(REG_14B8H, 0x00000040U);
            WAIT_STS(REG_142CH, 12, 0);
        ...
        else
        {
            ...
            r_rsip_func101(bswap_32big(0x1120aea2U), bswap_32big(0x5bcb3616U), bswap_32big(0x7f221ad0U), bswap_32big(0x2df5afbcU));
            r_rsip_func088();
