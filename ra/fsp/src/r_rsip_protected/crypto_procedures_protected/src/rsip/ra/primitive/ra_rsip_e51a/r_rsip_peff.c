                        ...
                        uint32_t       OutData_KDFInfo[])
{
    ...
    r_rsip_func_sub024(0x000034c3U, 0x00026cc6U, 0x000024c4U, 0x000024c5U);
    ...
    {
        r_rsip_func_sub024(0x38008c80U, 0xffffffbfU, 0x00020020U, 0x38008880U);
    ...
    else
    {
        ...
        else
        {
            ...
            if (CHCK_STS(REG_143CH, 22, 1))
            {
                ...
                r_rsip_func_sub025(0x0000b7e0U, 0x00000004U, 0x00002be6U);
