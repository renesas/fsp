 ...
 * Description  : Interface definition for the RSIP driver for RA8x2 module.
 ***********************************************************************************************************************
 * Supported Device : RA8x2
 **********************************************************************************************************************/
...
#define CIP_VERSION_MAJOR                    (0u)
#define CIP_VERSION_MINOR                    (5u)
...
#define CIP_DRV_RET_ERR_TAMPER_DETECT         ((cip_drv_err_t)0xAAAA0009UL) /* Tampering was detected */
...
typedef enum
{
    ...
    CIP_OEM_KEY_TYPE_HMAC_SHA3_224,
    CIP_OEM_KEY_TYPE_HMAC_SHA3_256,
    CIP_OEM_KEY_TYPE_HMAC_SHA3_384,
    CIP_OEM_KEY_TYPE_HMAC_SHA3_512,
    CIP_OEM_KEY_TYPE_CHACHA20_POLY1305,
