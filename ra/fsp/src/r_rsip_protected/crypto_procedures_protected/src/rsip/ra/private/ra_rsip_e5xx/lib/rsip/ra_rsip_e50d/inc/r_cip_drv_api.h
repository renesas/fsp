...
#define CIP_DRV_BASE_OEMROOTPKHASH_ADDR       (0x02E07400UL)
#define CIP_DRV_OEMROOTPKHASH_ADDR0           CIP_DRV_BASE_OEMROOTPKHASH_ADDR
#define CIP_DRV_OEMROOTPKHASH_ADDR1           (CIP_DRV_BASE_OEMROOTPKHASH_ADDR + (0x00000030UL))
#define CIP_DRV_OEMROOTPKHASH_ADDR2           (CIP_DRV_BASE_OEMROOTPKHASH_ADDR + (0x00000060UL))
#define CIP_DRV_OEMROOTPKHASH_ADDR3           (CIP_DRV_BASE_OEMROOTPKHASH_ADDR + (0x00000090UL))
#define CIP_DRV_OEMROOTPKHASH_ADDR_SIZE       (0x00000030UL)
