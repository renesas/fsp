...
static VOID gx_rotate_canvas_to_working_16bpp_draw(USHORT * pGetRow, USHORT * pPutRow, INT width, INT height,
                                                   INT stride);
static VOID gx_rotate_canvas_to_working_16bpp_draw_rorate90(USHORT * pGetRow,
                                                            USHORT * pPutRow,
                                                            INT      width,
                                                            INT      height,
                                                            INT      canvas_stride,
                                                            INT      disp_stride);
static VOID gx_rotate_canvas_to_working_16bpp_draw_rorate180(USHORT * pGetRow,
                                                             USHORT * pPutRow,
                                                             INT      width,
                                                             INT      height,
                                                             INT      stride);
static VOID gx_rotate_canvas_to_working_16bpp_draw_rorate270(USHORT * pGetRow,
                                                             USHORT * pPutRow,
                                                             INT      width,
                                                             INT      height,
                                                             INT      canvas_stride,
...
static VOID gx_rotate_canvas_to_working_32bpp_draw_rorate90(ULONG * pGetRow,
                                                            ULONG * pPutRow,
                                                            INT     width,
                                                            INT     height,
                                                            INT     canvas_stride,
                                                            INT     disp_stride);
static VOID gx_rotate_canvas_to_working_32bpp_draw_rorate180(ULONG * pGetRow,
                                                             ULONG * pPutRow,
                                                             INT     width,
                                                             INT     height,
                                                             INT     stride);
static VOID gx_rotate_canvas_to_working_32bpp_draw_rorate270(ULONG * pGetRow,
                                                             ULONG * pPutRow,
                                                             INT     width,
                                                             INT     height,
                                                             INT     canvas_stride,
...
static VOID gx_dave2d_rotate_canvas_to_working_image_draw(d2_device           * p_dave,
                                                          ...
                                                          GX_DISPLAY          * p_display,
                                                          GX_CANVAS           * p_canvas);
static VOID gx_renesas_display_driver_16bpp_32argb_pixelmap_simple_rotate(GX_DRAW_CONTEXT * p_context,
                                                                          INT               xpos,
                                                                          INT               ypos,
                                                                          GX_PIXELMAP     * p_pixelmap,
                                                                          INT               angle,
                                                                          INT               cx,
                                                                          INT               cy);
static VOID gx_renesas_display_driver_16bpp_32argb_pixelmap_rotate(GX_DRAW_CONTEXT * p_context,
                                                                   INT               xpos,
                                                                   INT               ypos,
                                                                   GX_PIXELMAP     * p_pixelmap,
                                                                   INT               angle,
                                                                   INT               cx,
                                                                   INT               cy);
static VOID gx_renesas_display_driver_16bpp_32argb_pixelmap_rotate_adjacent_pixeldata_get(
    pixelmap_adjacent_pixels_t * pixels,
    GX_PIXELMAP                * pixelmap,
    INT                          x,
    INT                          y);
static INT  gx_renesas_display_driver_16bpp_32argb_pixelmap_rotate_value_clip(INT value);
static VOID gx_renesas_display_driver_16bpp_32argb_pixelmap_rotate_adjacent_pixeldata_get_left_edge(
    pixelmap_adjacent_pixels_t * pixels,
    GX_PIXELMAP                * pixelmap,
    INT                          y);
static VOID gx_renesas_display_driver_16bpp_32argb_pixelmap_rotate_adjacent_pixeldata_get_top_edge(
    pixelmap_adjacent_pixels_t * pixels,
    GX_PIXELMAP                * pixelmap,
    INT                          x);
static VOID gx_renesas_display_driver_16bpp_32argb_pixelmap_rotate_adjacent_pixeldata_get_right_edge(
    pixelmap_adjacent_pixels_t * pixels,
    GX_PIXELMAP                * pixelmap,
    INT                          x,
    INT                          y);
static VOID gx_renesas_display_driver_16bpp_32argb_pixelmap_rotate_adjacent_pixeldata_get_bottom_edge(
    pixelmap_adjacent_pixels_t * pixels,
    GX_PIXELMAP                * pixelmap,
    INT                          x,
    INT                          y);
...
/*******************************************************************************************************************//**
 * @brief  GUIX display driver for FSP, 16bpp pixelmap rorate function with D/AVE 2D acceleration enabled.
        ...
        default:                       /* GX_COLOR_FORMAT_24XRGB or GX_COLOR_FORMAT_32ARGB */
        {
            if (pixelmap->gx_pixelmap_flags & GX_PIXELMAP_ALPHA)
            {
                if ((angle % 90) == 0)
                {
                    ...
                    gx_renesas_display_driver_16bpp_32argb_pixelmap_simple_rotate(context,
                                                                                  xpos,
                                                                                  ypos,
                                                                                  pixelmap,
                                                                                  angle,
                ...
                {
                    gx_renesas_display_driver_16bpp_32argb_pixelmap_rotate(context,
                                                                           xpos,
                                                                           ypos,
                                                                           pixelmap,
                                                                           angle,
                                                                    ...
                                                                    GX_CANVAS           * p_canvas)
{
    ...
    p_param->ymin =
        (d2_border) (p_display->gx_display_width - p_param->copy_clip.gx_rectangle_right - 1);
                                                           ...
                                                           GX_CANVAS           * p_canvas)
{
    ...
    else
    {
        ...
        {
            CHECK_DAVE_STATUS(d2_renderbox(p_dave, (d2_point) D2_FIX4((UINT) x),
                                           (d2_point) D2_FIX4((USHORT) p_param->ymin), (d2_width) D2_FIX4(1U),
                                           (d2_width) D2_FIX4((UINT) p_param->copy_height_rotated)));
...
static VOID gx_dave2d_rotated_frame_sync (GX_DISPLAY * display, GX_RECTANGLE * copy)
{
    ...
    _gx_utility_rectangle_define(&display_size, 0, 0, (GX_VALUE) (frame_width - 1), (GX_VALUE) (frame_height - 1));
    copy_clip = *copy;
    ...
    CHECK_DAVE_STATUS(d2_framebuffer(dave, pPutRow, (d2_s32) (frame_width), (d2_u32) (frame_width),
                                     (d2_u32) (frame_height), (d2_s32) mode))

    gx_dave2d_cliprect_set(dave, &copy_clip);
    gx_dave2d_alpha_set(dave, (UCHAR) GX_ALPHA_VALUE_OPAQUE);

    CHECK_DAVE_STATUS(d2_setblitsrc(dave, (void *) pGetRow, frame_width, frame_width, frame_height, mode))
...
/*******************************************************************************************************************//**
 * @brief  GUIX display driver for FSP, 16bpp pixelmap rorate function with 90/180/270 degree.
 ...
 **********************************************************************************************************************/
static VOID gx_renesas_display_driver_16bpp_32argb_pixelmap_simple_rotate (GX_DRAW_CONTEXT * context,
                                                                           INT               xpos,
                                                                           INT               ypos,
                                                                           GX_PIXELMAP     * pixelmap,
                                                                           INT               angle,
...
/*******************************************************************************************************************//**
 * @brief  Subroutine of gx_renesas_display_driver_16bpp_32argb_pixelmap_rotate_adjacent_pixeldata_get(). This function
...
/*******************************************************************************************************************//**
 * @brief  Subroutine of gx_renesas_display_driver_16bpp_32argb_pixelmap_rotate(). This function obtains 32-bit color
    ...
    INT                          y)
{
    ...
    else
    {
        ...
        if (x == -1)
        {
            gx_renesas_display_driver_16bpp_32argb_pixelmap_rotate_adjacent_pixeldata_get_left_edge(pixels, pixelmap,
                                                                                                    y);
        }
        else if (y == -1)
        {
            gx_renesas_display_driver_16bpp_32argb_pixelmap_rotate_adjacent_pixeldata_get_top_edge(pixels, pixelmap, x);
        }
        else if (x == (pixelmap->gx_pixelmap_width - 1))
        {
            gx_renesas_display_driver_16bpp_32argb_pixelmap_rotate_adjacent_pixeldata_get_right_edge(pixels,
                                                                                                     pixelmap,
                                                                                                     x,
                                                                                                     y);
        }
        ...
        {
            gx_renesas_display_driver_16bpp_32argb_pixelmap_rotate_adjacent_pixeldata_get_bottom_edge(pixels,
                                                                                                      pixelmap,
                                                                                                      x,
                                                                                                      y);
        }
...
/*******************************************************************************************************************//**
 * @brief  Subroutine of gx_renesas_display_driver_16bpp_32argb_pixelmap_rotate(). This function limits value to 255.
 ...
 **********************************************************************************************************************/
static VOID gx_renesas_display_driver_16bpp_32argb_pixelmap_rotate (GX_DRAW_CONTEXT * context,
                                                                    INT               xpos,
                                                                    INT               ypos,
                                                                    GX_PIXELMAP     * pixelmap,
                                                                    INT               angle,
                                                                    ...
                                                                    INT               cy)
{
    ...
    for (y = ((INT) clip->gx_rectangle_top - newypos); y < ((INT) clip->gx_rectangle_bottom - newypos); y++)
    {
        for (x = ((INT) clip->gx_rectangle_left - newxpos); x < ((INT) clip->gx_rectangle_right - newxpos); x++)
        {
            ...
            xx = (xx >> GX_FIXED_VAL_SHIFT) + srcxres;

            yy = (yy >> GX_FIXED_VAL_SHIFT) + srcyres;

            if ((xx >= -1) && (xx < (INT) pixelmap->gx_pixelmap_width) &&
                (yy >= -1) && (yy < (INT) pixelmap->gx_pixelmap_height))
            {
                gx_renesas_display_driver_16bpp_32argb_pixelmap_rotate_adjacent_pixeldata_get(&pixels, pixelmap, xx,
                                                                                              yy);

                red = (GX_COLOR) (((REDVAL_32BPP(pixels.a) * (pixels.a >> 24)) *
                                   (256 - (GX_COLOR) xdiff)) * (256 - (GX_COLOR) ydiff));
                red += (GX_COLOR) (((REDVAL_32BPP(pixels.b) * (pixels.b >> 24)) *
                                    (GX_COLOR) xdiff) * (256 - (GX_COLOR) ydiff));
                red += (GX_COLOR) (((REDVAL_32BPP(pixels.c) * (pixels.c >> 24)) *
                                    (GX_COLOR) ydiff) * (256 - (GX_COLOR) xdiff));
                red += (GX_COLOR) (((REDVAL_32BPP(pixels.d) * (pixels.d >> 24)) *
                                    (GX_COLOR) xdiff) * (GX_COLOR) ydiff);
                red >>= 16;

                green = (GX_COLOR) (((GREENVAL_32BPP(pixels.a) * (pixels.a >> 24)) *
                                     (256 - (GX_COLOR) xdiff)) * (256 - (GX_COLOR) ydiff));
                green += (GX_COLOR) (((GREENVAL_32BPP(pixels.b) * (pixels.b >> 24)) *
                                      (GX_COLOR) xdiff) * (256 - (GX_COLOR) ydiff));
                green += (GX_COLOR) (((GREENVAL_32BPP(pixels.c) * (pixels.c >> 24)) *
                                      (GX_COLOR) ydiff) * (256 - (GX_COLOR) xdiff));
                green += (GX_COLOR) (((GREENVAL_32BPP(pixels.d) * (pixels.d >> 24)) *
                                      (GX_COLOR) xdiff) * (GX_COLOR) ydiff);
                green >>= 16;

                blue = (GX_COLOR) (((BLUEVAL_32BPP(pixels.a) * (pixels.a >> 24)) *
                                    (256 - (GX_COLOR) xdiff)) * (256 - (GX_COLOR) ydiff));
                blue += (GX_COLOR) (((BLUEVAL_32BPP(pixels.b) * (pixels.b >> 24)) *
                                     (GX_COLOR) xdiff) * (256 - (GX_COLOR) ydiff));
                blue += (GX_COLOR) (((BLUEVAL_32BPP(pixels.c) * (pixels.c >> 24)) *
                                     (GX_COLOR) ydiff) * (256 - (GX_COLOR) xdiff));
                blue += (GX_COLOR) (((BLUEVAL_32BPP(pixels.d) * (pixels.d >> 24)) *
                                     (GX_COLOR) xdiff) * (GX_COLOR) ydiff);
                blue >>= 16;
                ...
                alpha += ((INT) (pixels.b >> 24) * xdiff) * ((INT) 256 - ydiff);
                alpha += ((INT) (pixels.c >> 24) * ydiff) * ((INT) 256 - xdiff);
                alpha += ((INT) (pixels.d >> 24) * xdiff) * ydiff;
                alpha  = (INT) ((UINT) alpha >> 16);

                alpha = gx_renesas_display_driver_16bpp_32argb_pixelmap_rotate_value_clip(alpha);
                if (alpha)
                {
                ...
                red   = (GX_COLOR) gx_renesas_display_driver_16bpp_32argb_pixelmap_rotate_value_clip((INT) red);
                green = (GX_COLOR) gx_renesas_display_driver_16bpp_32argb_pixelmap_rotate_value_clip((INT) green);
                blue  = (GX_COLOR) gx_renesas_display_driver_16bpp_32argb_pixelmap_rotate_value_clip((INT) blue);
...
static VOID gx_rotate_canvas_to_working_16bpp (GX_CANVAS * canvas, GX_RECTANGLE * copy, INT angle)
{
    ...
    else if (angle == 270)
    {
        ...
        gx_rotate_canvas_to_working_16bpp_draw_rorate270(pGetRow,
                                                         pPutRow,
                                                         copy_width,
                                                         copy_height,
                                                         canvas_stride,
    ...
    else
    {
        ...
        gx_rotate_canvas_to_working_16bpp_draw_rorate90(pGetRow,
                                                        pPutRow,
                                                        copy_width,
                                                        copy_height,
                                                        canvas_stride,
...
static VOID gx_rotate_canvas_to_working_32bpp (GX_CANVAS * canvas, GX_RECTANGLE * copy, INT angle)
{
    ...
    else if (angle == 270)
    {
        ...
        gx_rotate_canvas_to_working_32bpp_draw_rorate270(pGetRow,
                                                         pPutRow,
                                                         copy_width,
                                                         copy_height,
                                                         canvas_stride,
    ...
    else
    {
        ...
        gx_rotate_canvas_to_working_32bpp_draw_rorate90(pGetRow,
                                                        pPutRow,
                                                        copy_width,
                                                        copy_height,
                                                        canvas_stride,
