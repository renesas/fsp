 ...
 **********************************************************************************************************************/
void HW_SCE_p_func_sub001(uint32_t ARG1, uint32_t ARG2, uint32_t ARG3);
void HW_SCE_p_func_sub002(uint32_t ARG1);
...
void HW_SCE_p_func_sub012(uint32_t ARG1, uint32_t ARG2);
void HW_SCE_p_func_sub013(uint32_t ARG1);
void HW_SCE_p_func_sub014(uint32_t ARG1, uint32_t ARG2);
void HW_SCE_p_func_sub015(uint32_t ARG1, uint32_t ARG2);
void HW_SCE_p_func_sub016(uint32_t ARG1, uint32_t ARG2, uint32_t ARG3);
void HW_SCE_p_func_sub017(void);
void HW_SCE_p_func_sub018(uint32_t ARG1, uint32_t ARG2);
void HW_SCE_p_func_sub019(uint32_t ARG1);
void HW_SCE_p_func_sub100(const uint32_t ARG1[], const uint32_t ARG2[], const uint32_t PARAM[]);
