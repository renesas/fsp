...
void HW_SCE_Aes128GcmEncryptUpdateSub (const uint32_t InData_Text[], uint32_t OutData_Text[], const uint32_t MAX_CNT)
{
    ...
    {
        0xd582b1d1U, 0x4f0b4903U, 0xf09d42b1U, 0xf136c6e6U,
    };
    HW_SCE_p_func100(Param_p29u_func100_001);

    HW_SCE_p_func_sub016(0x00020061U, 0x00000020U, 0x20008d06U);
    ...
    {
        0x34836cf4U, 0x58c88a9fU, 0xf8691d0cU, 0xfd9076b3U,
    };
