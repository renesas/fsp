...
fsp_err_t HW_SCE_Aes128XtsEncryptInitSubGeneral(const uint32_t InData_KeyMode[],
                                                ...
                                                const uint32_t InData_Key[],
                                                const uint32_t InData_IV[]);
void HW_SCE_Aes128XtsEncryptUpdateSub(const uint32_t InData_Text[], uint32_t OutData_Text[],
...
fsp_err_t HW_SCE_Aes256XtsEncryptInitSub(const uint32_t InData_KeyMode[],
                                         ...
                                         const uint32_t InData_Key[],
                                         const uint32_t InData_IV[]);
void HW_SCE_Aes256XtsEncryptUpdateSub(const uint32_t InData_Text[], uint32_t OutData_Text[],
                                      const uint32_t MAX_CNT);
...
fsp_err_t HW_SCE_Aes128XtsDecryptInitSubGeneral(const uint32_t InData_KeyMode[],
                                                ...
                                                const uint32_t InData_Key[],
                                                const uint32_t InData_IV[]);
void HW_SCE_Aes128XtsDecryptUpdateSub(const uint32_t InData_Text[], uint32_t OutData_Text[],
                                      const uint32_t MAX_CNT);
...
fsp_err_t HW_SCE_Aes256XtsDecryptInitSub(const uint32_t InData_KeyMode[],
                                         ...
                                         const uint32_t InData_Key[],
                                         const uint32_t InData_IV[]);
void HW_SCE_Aes256XtsDecryptUpdateSub(const uint32_t InData_Text[], uint32_t OutData_Text[],
                                      const uint32_t MAX_CNT);
