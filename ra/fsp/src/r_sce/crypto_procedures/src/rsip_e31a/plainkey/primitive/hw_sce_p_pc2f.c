                                           ...
                                           uint32_t       OutData_Text[])
{
    ...
    {
        0x9ea2fc44U, 0x036e91c6U, 0xcfb0ccf9U, 0x29adbf8eU,
    };
    ...
    if (CHCK_STS(REG_40H, 22, 1))
    {
        ...
        {
            0x65141a16U, 0xbe813d65U, 0x0bc8f9f4U, 0x05ca1212U,
        };
    ...
    else
    {
        ...
        {
            0x413c2f88U, 0x5c3c396dU, 0xb4c612bcU, 0xe88c8597U,
        };
        ...
        {
            0x87d7217eU, 0x3e53cba8U, 0x07c6b5d6U, 0x75be6e23U,
        };
        HW_SCE_p_func100(Param_pc2f_func100_003);

        HW_SCE_p_func_sub016(0x00020061U, 0x40000020U, 0x0d00890eU);
        ...
        {
            0xa77f9192U, 0xf8a0bb5eU, 0x1262755eU, 0x45a1ad21U,
        };
        ...
        if (CHCK_STS(REG_40H, 22, 1))
        {
            ...
            {
                0xdb3f2032U, 0x3081082bU, 0x7b577db1U, 0x08c9a2f1U,
            };
            ...
            HW_SCE_p_func_sub007(0x000000a1U, 0x40000020U, 0x0d00880cU);
            WR1_PROG(REG_2CH, change_endian_long(0x00000000U));

            HW_SCE_p_func_sub007(0x000003c1U, 0x40000020U, 0x0d00890dU);
            WR4_ADDR(REG_2CH, &InData_Text[iLoop]);
            ...
            for (jLoop = 0U; jLoop < S_RAM[0]; jLoop++)
            {
                ...
                {
                    0xe350b7f3U, 0x6e838c22U, 0x9f3d7f43U, 0x8842d368U,
                };
            ...
            {
                0x59b711f1U, 0xee3a2a0cU, 0x5ef7109dU, 0x292aecedU,
            };
            ...
            WR1_PROG(REG_94H, 0x0000b4e0U);
            WR1_PROG(REG_94H, 0x00000010U);
            HW_SCE_p_func_sub021(0x40000020U, 0x0d00890dU, 0x81840007U);
            ...
            for (jLoop = 0U; jLoop < S_RAM[0]; jLoop++)
            {
                ...
                {
                    0xc16ec62dU, 0xf4c146d1U, 0x1ba65951U, 0x545d3a3dU,
                };
            ...
            {
                0x56038928U, 0x588c2fa7U, 0xa82a48f5U, 0xed229f1aU,
            };
            ...
            {
                0x2e07d167U, 0x320a6455U, 0x7426f1d4U, 0xf4a82c97U,
            };
        ...
        {
            0xc9bf204bU, 0xcae1ccbfU, 0xb36c267eU, 0x812c36c0U,
        };
