                                           ...
                                           uint32_t       OutData_Text[])
{
    ...
    {
        0x9c2f64d5U, 0x7832a189U, 0x0fb5f831U, 0xbb7f2bb1U,
    };
    ...
    if (CHCK_STS(REG_40H, 22, 1))
    {
        ...
        {
            0x46f39f88U, 0xe7072f86U, 0x1c02d5e5U, 0xafc52d1fU,
        };
    ...
    else
    {
        ...
        {
            0x6a354ddcU, 0x10a8054eU, 0x7d955b00U, 0x79eb430bU,
        };
        ...
        {
            0x59a03fa9U, 0x253c69a4U, 0x442f29aaU, 0x1cbac808U,
        };
        ...
        {
            0x9a389393U, 0x2517e6c9U, 0x664a2109U, 0xa146b58cU,
        };
        ...
        if (CHCK_STS(REG_40H, 22, 1))
        {
            HW_SCE_p_func_sub007(0x000003c1U, 0x40000020U, 0x0d008905U);
            WR4_ADDR(REG_2CH, &InData_Text[iLoop]);
            ...
            {
                0x2d480fc7U, 0x67919955U, 0x16a0bb3aU, 0xe43ab1a0U,
            };
            ...
            for (jLoop = 0U; jLoop < S_RAM[0]; jLoop++)
            {
                ...
                {
                    0x81d901baU, 0xbdacedbdU, 0x93399d78U, 0x48bf8131U,
                };
            ...
            {
                0xf37d345cU, 0x8df94728U, 0x45fbb8c3U, 0x7f7cbd0aU,
            };
            HW_SCE_p_func100(Param_pb9f_func100_006);
            WR1_PROG(REG_94H, 0x0000b4e0U);
            WR1_PROG(REG_94H, 0x00000010U);
            HW_SCE_p_func_sub021(0x40000020U, 0x0d008905U, 0x81840007U);
            ...
            for (jLoop = 0U; jLoop < S_RAM[0]; jLoop++)
            {
                ...
                {
                    0x910ed915U, 0xc6e84522U, 0xb1395bdaU, 0xb3e29e12U,
                };
            ...
            {
                0x6485fc1fU, 0x8ece303fU, 0x93db37f7U, 0xaa956d85U,
            };
            ...
            {
                0x36baf791U, 0xddcbfbdbU, 0xa2f90051U, 0x58bb561cU,
            };
        ...
        {
            0xd8f5a4a1U, 0x776c0a03U, 0xc7e05f70U, 0x88c38fdfU,
        };
