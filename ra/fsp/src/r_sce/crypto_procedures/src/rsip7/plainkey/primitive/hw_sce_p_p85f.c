                                           ...
                                           uint32_t       OutData_Text[])
{
    ...
    HW_SCE_p_func100(0xf2d5caeaU, 0xa95a8e2eU, 0x38631688U, 0xf8f091feU);
    WR1_PROG(REG_143CH, 0x00400000U);
    WR1_PROG(REG_1458H, 0x00000000U);

    if (CHCK_STS(REG_143CH, 22, 1))
    {
        HW_SCE_p_func102(0x9e7eecabU, 0xcff542d8U, 0xc6b4f0c2U, 0xe3dcca93U);
    ...
    else
    {
        ...
        HW_SCE_p_func100(0x584722dcU, 0x09f345fbU, 0x5371b07aU, 0xa9edfc74U);
        WR1_PROG(REG_143CH, 0x00400000U);
        WR1_PROG(REG_1458H, 0x00000000U);

        if (CHCK_STS(REG_143CH, 22, 1))
        {
            HW_SCE_p_func100(0xa474b93cU, 0x2023d9b5U, 0x1df27035U, 0x23482c09U);
            ...
            HW_SCE_p_func101(0xcf856c9aU, 0xcf5f6b6aU, 0x841b155aU, 0x8a4b85c1U);
        }
        ...
        HW_SCE_p_func100(0x2396ecc0U, 0x46860decU, 0x1ecc1d95U, 0xb9834e89U);
        WR1_PROG(REG_143CH, 0x00400000U);
        WR1_PROG(REG_1458H, 0x00000000U);

        if (CHCK_STS(REG_143CH, 22, 1))
        {
            HW_SCE_p_func102(0x228d120cU, 0xfa8fb72eU, 0xabd4f72dU, 0x15c7ff79U);
            WR1_PROG(REG_14BCH, 0x00000040U);
            WAIT_STS(REG_142CH, 12, 0);
        ...
        {
            HW_SCE_p_func102(0x3adf254bU, 0xf1d8e7b1U, 0x09e369a4U, 0x3431286cU);
            WR1_PROG(REG_14BCH, 0x00000040U);
            WAIT_STS(REG_142CH, 12, 0);
