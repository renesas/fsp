                                                   ...
                                                   uint32_t       OutData_Text[])
{
    ...
    HW_SCE_p_func101(0x2fca5c49U, 0xc9132cafU, 0x1ec4e732U, 0xacafb0f5U);
    HW_SCE_p_func044();
    ...
    WR1_PROG(REG_1444H, 0x000083c2U);
    ...
    WAIT_STS(REG_1444H, 31, 1);
    WR4_ADDR(REG_1420H, &InData_KeyIndex[133]);
    ...
    HW_SCE_p_func100(0x9a0c7d6cU, 0x81b1aebbU, 0xbca9cf59U, 0xfdf6dcd0U);
    WR1_PROG(REG_143CH, 0x00400000U);
    WR1_PROG(REG_1458H, 0x00000000U);

    if (CHCK_STS(REG_143CH, 22, 1))
    {
        HW_SCE_p_func102(0x14a304dcU, 0xc64dcbc2U, 0x3c2d6fc7U, 0x032a787bU);
    ...
    else
    {
        ...
        HW_SCE_p_func100(0xefd2ddefU, 0x05c53649U, 0x2212e8baU, 0x0cb1daabU);
        WR1_PROG(REG_143CH, 0x00400000U);
        WR1_PROG(REG_1458H, 0x00000000U);

        if (CHCK_STS(REG_143CH, 22, 1))
        {
            HW_SCE_p_func102(0x4fa808d2U, 0x65af2913U, 0xff8fdff4U, 0x1d88826eU);
            WR1_PROG(REG_14B8H, 0x00000040U);
            WAIT_STS(REG_142CH, 12, 0);
        ...
        {
            HW_SCE_p_func100(0xfbcaa96bU, 0x9678d6a7U, 0x8c19340dU, 0x2f9c58b8U);
            ...
            for (iLoop = 0U; iLoop < 64U; )
            {
                ...
                HW_SCE_p_func100(0x663332e7U, 0x6b54ef0cU, 0xc1e8ff49U, 0xd5c4d3a0U);
                ...
                HW_SCE_p_func101(0x1a3d6677U, 0xb48d4a11U, 0x63487566U, 0x313adc80U);
                iLoop = iLoop + 8U;
            }
            ...
            HW_SCE_p_func100(0x2b9be288U, 0x7db40899U, 0x2de745e1U, 0xf9fb1f32U);
            WR1_PROG(REG_1408H, 0x00020000U);

            HW_SCE_p_func102(0x7ace1358U, 0x7080deb5U, 0xd07afc33U, 0x0cf5776bU);
            WR1_PROG(REG_14B8H, 0x00000040U);
            WAIT_STS(REG_142CH, 12, 0);
