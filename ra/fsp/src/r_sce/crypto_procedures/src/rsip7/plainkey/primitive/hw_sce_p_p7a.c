                                                   ...
                                                   uint32_t       OutData_Text[])
{
    ...
    HW_SCE_p_func101(0x93ba7f5cU, 0xad11200aU, 0x74a345afU, 0x71d47de3U);
    HW_SCE_p_func044();
    ...
    HW_SCE_p_func100(0xec343e65U, 0xf88a6ae3U, 0x148e80fbU, 0x4f478b7aU);
    WR1_PROG(REG_143CH, 0x00400000U);
    WR1_PROG(REG_1458H, 0x00000000U);

    if (CHCK_STS(REG_143CH, 22, 1))
    {
        HW_SCE_p_func102(0x8999ab21U, 0x7e9a4e5bU, 0xee62c661U, 0xd216e031U);
    ...
    else
    {
        ...
        HW_SCE_p_func100(0x3cf3e725U, 0x58c250a6U, 0x6790e2ffU, 0xa73e9832U);
        WR1_PROG(REG_143CH, 0x00400000U);
        WR1_PROG(REG_1458H, 0x00000000U);

        if (CHCK_STS(REG_143CH, 22, 1))
        {
            HW_SCE_p_func102(0x875be366U, 0x2cf9ec46U, 0xdc93114cU, 0x3db9438aU);
            WR1_PROG(REG_14B8H, 0x00000040U);
            WAIT_STS(REG_142CH, 12, 0);
        ...
        {
            HW_SCE_p_func100(0x930a6449U, 0x0e006525U, 0xa6afddbcU, 0xdbbec0c8U);
            ...
            for (iLoop = 0U; iLoop < 96U; )
            {
                ...
                HW_SCE_p_func100(0x483c164aU, 0x8a397a0cU, 0x7ffbf075U, 0x62210565U);
                ...
                HW_SCE_p_func101(0xfdf861e7U, 0xe880802cU, 0xb627f622U, 0x535b1bb1U);
                iLoop = iLoop + 8U;
            }
            ...
            HW_SCE_p_func100(0x575c5a80U, 0x1f2219f5U, 0x65047769U, 0x1e106b40U);
            WR1_PROG(REG_1408H, 0x00020000U);

            HW_SCE_p_func102(0xe403e68bU, 0x90dcbd2fU, 0xd252a604U, 0x05d107d4U);
            WR1_PROG(REG_14B8H, 0x00000040U);
            WAIT_STS(REG_142CH, 12, 0);
