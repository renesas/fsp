                                           ...
                                           uint32_t       OutData_Text[])
{
    ...
    HW_SCE_p_func100(0x96010a66U, 0x66d60c3fU, 0x210dceffU, 0xd4ca098aU);
    WR1_PROG(REG_143CH, 0x00400000U);
    WR1_PROG(REG_1458H, 0x00000000U);

    if (CHCK_STS(REG_143CH, 22, 1))
    {
        HW_SCE_p_func102(0xc90ddef0U, 0xac7a0e9bU, 0x6cd96516U, 0x2047f5e1U);
    ...
    else
    {
        ...
        HW_SCE_p_func100(0x807835ceU, 0x16dbb5deU, 0x086fd360U, 0xdadc74bcU);
        WR1_PROG(REG_143CH, 0x00400000U);
        WR1_PROG(REG_1458H, 0x00000000U);
        ...
        if (CHCK_STS(REG_143CH, 22, 1))
        {
            ...
            HW_SCE_p_func100(0xf4eb2b33U, 0x1b3fe838U, 0xa1fa334aU, 0xb22bb424U);
            WR1_PROG(REG_1600H, 0x0000b420U);
            WR1_PROG(REG_1458H, 0x00000000U);
            WR1_PROG(REG_1600H, 0x00000080U);
            WR1_PROG(REG_1458H, 0x00000000U);
            ...
            HW_SCE_p_func101(0xa56a96f2U, 0x0a2bdaf3U, 0x8ed58a18U, 0xf4b6f120U);
        }
        else
        {
            HW_SCE_p_func101(0x2f780300U, 0x37d566c8U, 0xa29c2518U, 0x0be83819U);
        }
