                                           ...
                                           uint32_t       OutData_DataT[])
{
    ...
    HW_SCE_p_func100(0xe2ea70cdU, 0xd776bfa8U, 0xbf38a30dU, 0x1ed70bedU);
    WR1_PROG(REG_143CH, 0x00400000U);
    WR1_PROG(REG_1458H, 0x00000000U);

    if (CHCK_STS(REG_143CH, 22, 1))
    {
        HW_SCE_p_func102(0xf4680a67U, 0xc36b9da9U, 0x7383107dU, 0x56dd6695U);
    ...
    else
    {
        ...
        HW_SCE_p_func100(0x6c9780daU, 0x34924041U, 0x29528d6cU, 0xd2f3cb67U);
        WR1_PROG(REG_143CH, 0x00400000U);
        WR1_PROG(REG_1458H, 0x00000000U);

        if (CHCK_STS(REG_143CH, 22, 1))
        {
            HW_SCE_p_func100(0x7b48b4aaU, 0x287007a1U, 0xb10f8d46U, 0xfec66f3fU);
            ...
            HW_SCE_p_func101(0x9cd0929bU, 0xf1ce93a2U, 0xca822daaU, 0xb401cae1U);
        }

        HW_SCE_p_func100(0xce083d57U, 0xa6b1c2b7U, 0x9e7ea576U, 0x42e5bda0U);
        ...
        HW_SCE_p_func102(0x22f22c82U, 0x70cac744U, 0x31e5a7b5U, 0xe1e68f41U);
        WR1_PROG(REG_14BCH, 0x00000040U);
        WAIT_STS(REG_142CH, 12, 0);
