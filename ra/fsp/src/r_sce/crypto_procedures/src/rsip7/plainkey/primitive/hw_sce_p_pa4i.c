                                          ...
                                          const uint32_t Header_Len)
{
    ...
    HW_SCE_p_func100(0xed97275dU, 0xac49b932U, 0xfdd617adU, 0x84c0fd7cU);
    WR1_PROG(REG_143CH, 0x00400000U);
    WR1_PROG(REG_1458H, 0x00000000U);

    if (CHCK_STS(REG_143CH, 22, 1))
    {
        HW_SCE_p_func102(0x93f751b3U, 0x4fd3cba9U, 0x67fa2c0fU, 0xd9f7aa63U);
    ...
    else
    {
        ...
        HW_SCE_p_func100(0x3f7dc3caU, 0x7e47557aU, 0x3c0f6441U, 0x9a7469a5U);
        WR1_PROG(REG_143CH, 0x00400000U);
        WR1_PROG(REG_1458H, 0x00000000U);
        ...
        if (CHCK_STS(REG_143CH, 22, 1))
        {
            ...
            HW_SCE_p_func101(0xdc225078U, 0x2507f149U, 0x87fbbb69U, 0x81af3feeU);
            HW_SCE_p_func043();
            ...
            HW_SCE_p_func101(0xf4b13558U, 0x4da2ccffU, 0x4e55d48dU, 0xf5e890bbU);
        }
        else
        {
            WR1_PROG(REG_1444H, 0x000000c7U);
            ...
            HW_SCE_p_func101(0x0a89acd1U, 0x3730925aU, 0x797a0346U, 0x21dfbe54U);
            HW_SCE_p_func068();
        ...
        HW_SCE_p_func100(0x7e4f1290U, 0xb2700370U, 0x744997ccU, 0x50c0fd52U);
        ...
        HW_SCE_p_func100(0x8da6185eU, 0xe4e7e256U, 0x7e2839caU, 0xfd5831a1U);
        ...
        HW_SCE_p_func100(0x3acd920dU, 0x22a58ad3U, 0x884aaa0cU, 0xbb736313U);
        WR1_PROG(REG_143CH, 0x00400000U);
        WR1_PROG(REG_1458H, 0x00000000U);

        if (CHCK_STS(REG_143CH, 22, 1))
        {
            HW_SCE_p_func102(0xde25d67aU, 0x70d71d54U, 0x35eae998U, 0x0842d425U);
            WR1_PROG(REG_14BCH, 0x00000040U);
            WAIT_STS(REG_142CH, 12, 0);
