                                                   ...
                                                   uint32_t       OutData_Text[])
{
    ...
    HW_SCE_p_func101(0xcaaff484U, 0xf3d64157U, 0x08f18170U, 0xb3ead2ebU);
    HW_SCE_p_func044();
    ...
    HW_SCE_p_func100(0x19069f6bU, 0x51d634f9U, 0x5e78aa03U, 0x9841f352U);
    WR1_PROG(REG_143CH, 0x00400000U);
    WR1_PROG(REG_1458H, 0x00000000U);

    if (CHCK_STS(REG_143CH, 22, 1))
    {
        HW_SCE_p_func102(0x475e1bf5U, 0xde0ff3bfU, 0xccacc0b0U, 0xa72cf086U);
    ...
    else
    {
        ...
        HW_SCE_p_func100(0x8617eedfU, 0x84b9848cU, 0xff23ec2dU, 0xc6ad32b4U);
        WR1_PROG(REG_143CH, 0x00400000U);
        WR1_PROG(REG_1458H, 0x00000000U);

        if (CHCK_STS(REG_143CH, 22, 1))
        {
            HW_SCE_p_func102(0xe9cc1b75U, 0x92c319b7U, 0xaca47790U, 0x7264a510U);
            WR1_PROG(REG_14B8H, 0x00000040U);
            WAIT_STS(REG_142CH, 12, 0);
        ...
        {
            HW_SCE_p_func100(0x1a37752eU, 0x160eda7cU, 0xd43f0e38U, 0x35ed3c61U);
            ...
            for (iLoop = 0U; iLoop < 96U; )
            {
                ...
                HW_SCE_p_func100(0x8cb8e41fU, 0xe7142edfU, 0x96619833U, 0xd00de614U);
                ...
                HW_SCE_p_func101(0xd0090c90U, 0xe0785e21U, 0x3d817c81U, 0x62951e7bU);
                iLoop = iLoop + 8U;
            }
            ...
            HW_SCE_p_func100(0xa23534d8U, 0xa0414251U, 0x8abcca05U, 0x1cb946bbU);
            WR1_PROG(REG_1408H, 0x00020000U);

            HW_SCE_p_func102(0x1052126eU, 0x3a6fbd3eU, 0x6e8c3200U, 0x5ca2699dU);
            WR1_PROG(REG_14B8H, 0x00000040U);
            WAIT_STS(REG_142CH, 12, 0);
