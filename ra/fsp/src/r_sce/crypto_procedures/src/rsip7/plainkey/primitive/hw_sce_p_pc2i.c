...
fsp_err_t HW_SCE_Aes256XtsDecryptInitSub (const uint32_t InData_KeyIndex[], const uint32_t InData_IV[])
{
    ...
    HW_SCE_p_func101(0xda226a65U, 0x44ace6b3U, 0x37aec6bdU, 0xada71590U);
    HW_SCE_p_func044();

    HW_SCE_p_func100(0x096ed48eU, 0x526ae11eU, 0x6f203addU, 0x8ba56759U);
    ...
    HW_SCE_p_func100(0xe23657b4U, 0xb724fb3dU, 0xa02f7c5cU, 0xff025323U);
    WR1_PROG(REG_1824H, 0x08000095U);
    WR1_PROG(REG_1400H, 0x00420011U);
    WAIT_STS(REG_1404H, 30, 0);
    WR1_PROG(REG_143CH, 0x00001800U);

    HW_SCE_p_func100(0x9b1e1bd3U, 0x4425433cU, 0x1bba2630U, 0xc4a8f1bdU);
    WR1_PROG(REG_1444H, 0x000007c2U);
    WR1_PROG(REG_1A2CH, 0x40000100U);
    ...
    HW_SCE_p_func100(0xe0501d1fU, 0xb6dcd4cdU, 0x8619c7d2U, 0xeed7612cU);
    ...
    HW_SCE_p_func100(0x2228f979U, 0x62e272bcU, 0xbe1ff2ecU, 0x281e5214U);
    WR1_PROG(REG_143CH, 0x00400000U);
    WR1_PROG(REG_1458H, 0x00000000U);

    if (CHCK_STS(REG_143CH, 22, 1))
    {
        HW_SCE_p_func102(0x0f746abcU, 0x3de26c48U, 0x69477201U, 0xa9354859U);
