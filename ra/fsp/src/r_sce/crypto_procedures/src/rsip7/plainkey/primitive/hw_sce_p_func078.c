...
void HW_SCE_p_func078 (uint32_t ARG1)
{
    ...
    for (iLoop = ARG1 + 36U; iLoop < ARG1 + 52U; )
    {
        WAIT_STS(REG_1444H, 31, 1);
        WR4_ADDR(REG_1420H, &S_FLASH2[iLoop]);
        WAIT_STS(REG_1444H, 31, 1);
        WR4_ADDR(REG_1420H, &S_FLASH2[iLoop + 4]);
    ...
    for (iLoop = ARG1 + 52U; iLoop < ARG1 + 68U; )
    {
        WAIT_STS(REG_1444H, 31, 1);
        WR4_ADDR(REG_1420H, &S_FLASH2[iLoop]);
        WAIT_STS(REG_1444H, 31, 1);
    ...
    for (iLoop = ARG1 + 68U; iLoop < ARG1 + 84U; )
    {
        WAIT_STS(REG_1444H, 31, 1);
        WR4_ADDR(REG_1420H, &S_FLASH2[iLoop]);
        WAIT_STS(REG_1444H, 31, 1);
    ...
    for (iLoop = ARG1 + 84U; iLoop < ARG1 + 100U; )
    {
        WAIT_STS(REG_1444H, 31, 1);
        WR4_ADDR(REG_1420H, &S_FLASH2[iLoop]);
        WAIT_STS(REG_1444H, 31, 1);
    ...
    for (iLoop = ARG1 + 100U; iLoop < ARG1 + 116U; )
    {
        WAIT_STS(REG_1444H, 31, 1);
        WR4_ADDR(REG_1420H, &S_FLASH2[iLoop]);
        WAIT_STS(REG_1444H, 31, 1);
    ...
    for (iLoop = ARG1 + 116U; iLoop < ARG1 + 132U; )
    {
        WAIT_STS(REG_1444H, 31, 1);
        WR4_ADDR(REG_1420H, &S_FLASH2[iLoop]);
        WAIT_STS(REG_1444H, 31, 1);
