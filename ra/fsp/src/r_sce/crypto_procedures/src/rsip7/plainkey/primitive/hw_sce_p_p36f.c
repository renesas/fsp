                                           ...
                                           uint32_t       OutData_Text[])
{
    ...
    HW_SCE_p_func100(0x91eb0248U, 0x7b3cb5f1U, 0xec525139U, 0x949bd158U);
    WR1_PROG(REG_143CH, 0x00400000U);
    WR1_PROG(REG_1458H, 0x00000000U);

    if (CHCK_STS(REG_143CH, 22, 1))
    {
        HW_SCE_p_func102(0x63fc7854U, 0x6e11ff5dU, 0x056c3c91U, 0x3a5060b1U);
    ...
    else
    {
        ...
        HW_SCE_p_func100(0x0d028c06U, 0x485b3b78U, 0x22517aafU, 0x918f55bdU);
        WR1_PROG(REG_143CH, 0x00400000U);
        WR1_PROG(REG_1458H, 0x00000000U);

        if (CHCK_STS(REG_143CH, 22, 1))
        {
            HW_SCE_p_func100(0xb52a1421U, 0xfe17f96fU, 0x57f99900U, 0x6c46c4f1U);
            ...
            HW_SCE_p_func101(0x0c2b62f9U, 0x20d0c90bU, 0x1e04b0c8U, 0xbd8a4125U);
        }
        else
        {
        }
        ...
        HW_SCE_p_func100(0x11e900d9U, 0x22859cc5U, 0x74b435f8U, 0x490d783eU);
        WR1_PROG(REG_143CH, 0x00400000U);
        WR1_PROG(REG_1458H, 0x00000000U);

        if (CHCK_STS(REG_143CH, 22, 1))
        {
            HW_SCE_p_func102(0xf5b40977U, 0xddb7df38U, 0x0370d101U, 0x21c6b35aU);
            WR1_PROG(REG_14BCH, 0x00000040U);
            WAIT_STS(REG_142CH, 12, 0);
        ...
        {
            HW_SCE_p_func102(0x66750055U, 0xe3ae3578U, 0xaf10aee6U, 0xad2bbd2dU);
            WR1_PROG(REG_14BCH, 0x00000040U);
            WAIT_STS(REG_142CH, 12, 0);
