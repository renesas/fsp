...
fsp_err_t HW_SCE_Aes256CcmEncryptInitSub(uint32_t *InData_KeyIndex, uint32_t *InData_IV, uint32_t *InData_Header, uint32_t Header_Len)
{
    ...
    HW_SCE_p_func101(0x7284ec1aU, 0xaa15c187U, 0x16838c12U, 0xa7399e51U);
    HW_SCE_p_func043();
    ...
    SCE->REG_100H = change_endian_long(0x000000a1U);
    HW_SCE_p_func101(0x518b8ce9U, 0x8dbf76c4U, 0x51cce413U, 0xb6ee3bb5U);
    HW_SCE_p_func044();
...
/***********************************************************************************************************************
End of function ./input_dir/S6C1/Cryptographic_PlainKey/HW_SCE_p_pa1i.prc
***********************************************************************************************************************/
