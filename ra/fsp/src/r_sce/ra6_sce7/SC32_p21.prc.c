...
/////////////////////////////////////////////////////////////////////////
// <SC32#2 AES-256 Decryption with ECB Mode>                           //
// Procedure number: 21                                                //
// File name      : SC32_p21L.prc                                      //
...
// polling        : 141 + (MAX_CNT/4-1)*15 cycle                       //
                                    ...
                                    uint32_t       * OutData_Text)
{
    ...
    SC32_function001(0x39f8706d, 0xe56f52b7, 0x439b25a7, 0x01165d8a);
    WR1_PROG(REG_1CH, 0x00000084);
    WR1_PROG(REG_A4H, 0x00080805);
    WAIT_STS(REG_00H, 21, 1);
    WR4_ADDR(REG_A0H, &InData_Key[0]);

    SC32_function001(0x5692c882, 0x27b2efa6, 0xe0cd15a3, 0x6ee5e757);
    WR1_PROG(REG_1CH, 0x00000084);
    WR1_PROG(REG_A4H, 0x00090805);
    WAIT_STS(REG_00H, 21, 1);
    WR4_ADDR(REG_A0H, &InData_Key[4]);

    SC32_function001(0x11ea5c4a, 0x1a3e556a, 0x7fbba6d9, 0x0f174fa4);
    ...
    SC32_function001(0x311c6c4a, 0xa9a70622, 0x65b13efe, 0xa3e4b879);
    WR1_PROG(REG_1CH, 0x00400000);
    WR1_PROG(REG_1D0H, 0x00000000);

    if (CHCK_STS(REG_1CH, 22, 1))
    {
        SC32_function003(0xa9e9b0d3, 0xb03b8d97, 0xaf4e6810, 0xa70198a6);
    ...
    {
        SC32_function003(0xc7d3343d, 0x071acf6c, 0x4ca844e4, 0x06431791);
        WR1_PROG(REG_1BCH, 0x00000040);
        WAIT_STS(REG_18H, 12, 0);
