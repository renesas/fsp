...
// <SC32#2 128bit Random Number Generation>                            //
// Procedure number: 03                                                //
// File name      : SC32_p03_r1.prc                                    //
...
// polling        : 129 cycle                                          //
// polling access :  14 cycle                                          //
// write access   :  40 times                                          //
// read  access   :   5 times                                          //
/////////////////////////////////////////////////////////////////////////
...
/*******************************************************************************************************************//**
 * Generate 128-bit random number using SCE HW TRNG
 **********************************************************************************************************************/
...
fsp_err_t HW_SCE_RNG_Read (uint32_t * OutData_Text) {
    ...
    SC32_function001(0x8fbf6fd2, 0x2b6d63c4, 0x1ed1f2a2, 0xc2af1295);
    ...
    WAIT_STS(REG_00H, 25, 0);
    WR1_PROG(REG_1CH, 0x00001800);
    SC32_function001(0x7312c1f2, 0xfd001219, 0x2990a307, 0xdd986944);
    WR1_PROG(REG_104H, 0x00000052);
    ...
    SC32_function003(0x35b33c76, 0x372bfd85, 0xbaef971e, 0xd17aec73);
