...
/////////////////////////////////////////////////////////////////////////
// <SC32#2 AES-128 Encryption with ECB Mode>                           //
// Procedure number: 04                                                //
// File name      : SC32_p04L.prc                                      //
...
// polling        : 97 + (MAX_CNT/4-1)*11 cycle                        //
                                    ...
                                    uint32_t       * OutData_Text)
{
    ...
    SC32_function001(0x20de957e, 0x15b682e5, 0xab3bc706, 0x9702808d);
    WR1_PROG(REG_1CH, 0x00000084);
    WR1_PROG(REG_A4H, 0x00080805);
    WAIT_STS(REG_00H, 21, 1);
    WR4_ADDR(REG_A0H, &InData_Key[0]);

    SC32_function001(0x04436080, 0x0d75baa3, 0x6acd7deb, 0xe5dbcd05);
    ...
    SC32_function001(0x7266b2d3, 0x71eb6652, 0x81c96ff8, 0xc003c842);
    WR1_PROG(REG_1CH, 0x00400000);
    WR1_PROG(REG_1D0H, 0x00000000);

    if (CHCK_STS(REG_1CH, 22, 1))
    {
        SC32_function003(0xe1d167ea, 0x79fc13e5, 0x5b0df397, 0x88604ac4);
    ...
    {
        SC32_function003(0x39d1e5ff, 0xf1b66f63, 0xe575f8a5, 0xd32a3ae8);
        WR1_PROG(REG_1BCH, 0x00000040);
        WAIT_STS(REG_18H, 12, 0);
