...
//////////////////////////////////////////////////////////////////////
// <SC32#2 AES-256 Encryption with CBC Mode>                        //
// Procedure number: 22                                             //
// File name      : SC32_p22L.prc                                   //
                                    ...
                                    uint32_t       * OutData_IV)
{
    ...
    SC32_function001(0x0044aada, 0x575e7618, 0x01ddb8cc, 0xea6cde61);
    WR1_PROG(REG_1CH, 0x00000084);
    WR1_PROG(REG_A4H, 0x00080805);
    WAIT_STS(REG_00H, 21, 1);
    WR4_ADDR(REG_A0H, &InData_Key[0]);

    SC32_function001(0xeb0eb9ee, 0x80fb19af, 0xccfdf01e, 0x298fb284);
    WR1_PROG(REG_1CH, 0x00000084);
    ...
    SC32_function001(0x9a55a9e1, 0x14fb27a1, 0xd240a0bb, 0x74bf7205);
    ...
    SC32_function001(0xe6207376, 0x315e32d5, 0xa3a3813f, 0x976b2380);
    ...
    if (CHCK_STS(REG_1CH, 22, 1))
    {
        ...
        SC32_function003(0x18355190, 0x3ff4d5d6, 0x563ce942, 0x19a1e4ae);
    ...
    {
        SC32_function001(0x364e3216, 0x8b2c4260, 0x146920d9, 0xf3f13e40);
        ...
        SC32_function003(0x0e13e515, 0xf1c507c2, 0xc36d1fbf, 0x67f08123);
        WR1_PROG(REG_1BCH, 0x00000040);
        WAIT_STS(REG_18H, 12, 0);
