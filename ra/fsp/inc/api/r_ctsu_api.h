...
{
    ctsu_cap_t      cap;        ///< CTSU Measurement Operation Start Trigger Select
    ...
    ctsu_atune0_t   atune0;     ///< CTSU Power Supply Operating Mode Setting
    ...
    ctsu_clk_t      clk;        ///< CTSU Operating Clock Select
    ...
    uint16_t        threshold_3freq;        ///< CTSU majority threshold at three frequency (CTSU2 Only)
