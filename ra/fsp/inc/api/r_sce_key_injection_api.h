...
#define R_SCE_ECC_KEY_LENGTH_BYTE_SIZE                           (64U)
#define R_SCE_ECC_PRIVATE_KEY_MANAGEMENT_INFO_WORD_SIZE          (16U)
...
/** ECC 256 public wrapped key data structure */
...
/** ECC 256 private wrapped key data structure */
