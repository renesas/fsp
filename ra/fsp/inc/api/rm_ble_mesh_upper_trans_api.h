...
{
    RM_BLE_MESH_UPPER_TRANS_EVENT_ACCESS                       = 0x00,
    RM_BLE_MESH_UPPER_TRANS_EVENT_CONTROL                      = 0x01,
    RM_BLE_MESH_UPPER_TRANS_EVENT_FRIENDSHIP_SETUP             = 0x02,
    RM_BLE_MESH_UPPER_TRANS_EVENT_FRIENDSHIP_SUBSCRIPTION_LIST = 0x03,
    RM_BLE_MESH_UPPER_TRANS_EVENT_FRIENDSHIP_CLEAR             = 0x04,
    RM_BLE_MESH_UPPER_TRANS_EVENT_FRIENDSHIP_TERMINATE         = 0x05,
...
typedef struct st_rm_ble_mesh_upper_trans_access_layer_pdu
{
    ...
    uint8_t * p_label;                                 ///< Lable UUID, represending Virtual Address of Destination
...
{
    /** Register Inerface with Transport Layer.
     * @par Implemented as
    ...
    /** Unregister Inerface with Transport Layer.
     * @par Implemented as
     ...
     *
     * @param[in]  p_ctrl         Pointer to control structure.
     * @param[in]  action         Will be one of RM_BLE_MESH_UPPER_TRANS_CONTROL_OPCODE_FRIEND_SUBSCRN_LIST_ADD or RM_BLE_MESH_UPPER_TRANS_CONTROL_OPCODE_FRIEND_SUBSCRN_LIST_REMOVE.
