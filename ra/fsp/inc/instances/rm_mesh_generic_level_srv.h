...
#ifndef RM_MESH_GENERIC_LEVEL_SRV_H
#define RM_MESH_GENERIC_LEVEL_SRV_H
...
/*******************************************************************************************************************//**
 *
 * @addtogroup RM_MESH_GENERIC_LEVEL_SRV
 * @{
 **********************************************************************************************************************/
 ...
 */
typedef struct st_rm_mesh_generic_level_srv_info
{
    /** Generic Level */
    uint16_t level;
...
typedef struct st_rm_mesh_generic_level_srv_instance_ctrl
{
...
} rm_mesh_generic_level_srv_instance_ctrl_t;
...
extern const rm_ble_mesh_model_server_api_t g_rm_ble_mesh_model_server_on_rm_mesh_generic_level_srv;
...
fsp_err_t RM_MESH_GENERIC_LEVEL_SRV_StateUpdate(rm_ble_mesh_model_server_ctrl_t * const         p_ctrl,
                                                rm_ble_mesh_access_server_state_t const * const p_state);

/*******************************************************************************************************************//**
 * @} (end addgroup RM_MESH_GENERIC_LEVEL_SRV)
 **********************************************************************************************************************/

/* Common macro for FSP header files. There is also a corresponding FSP_HEADER macro at the top of this file. */
FSP_FOOTER

#endif                                 // RM_MESH_GENERIC_LEVEL_SRV_H
