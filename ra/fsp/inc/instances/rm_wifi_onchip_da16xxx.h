 ...
 * @{
 **********************************************************************************************************************/
#ifndef RM_WIFI_ONCHIP_DA16XXX_H
#define RM_WIFI_ONCHIP_DA16XXX_H
...
#include "rm_wifi_onchip_da16xxx_cfg.h"
...
#ifndef rm_wifi_onchip_da16xxx_uart_callback
...
#define WIFI_ONCHIP_DA16XXX_TKIP_ENC_TYPE        (0)
#define WIFI_ONCHIP_DA16XXX_AES_ENC_TYPE         (1)
#define WIFI_ONCHIP_DA16XXX_TKIP_AES_ENC_TYPE    (2)
...
typedef enum e_wifi_onchip_da16xxx_sntp_enable
{
    WIFI_ONCHIP_DA16XXX_SNTP_DISABLE = 0,
    WIFI_ONCHIP_DA16XXX_SNTP_ENABLE  = 1
} wifi_onchip_da16xxx_sntp_enable_t;

/** DA16XXX Wifi socket status types */
typedef enum e_da16xxx_socket_status
{
    WIFI_ONCHIP_DA16XXX_SOCKET_STATUS_CLOSED = 0,
    WIFI_ONCHIP_DA16XXX_SOCKET_STATUS_SOCKET,
    WIFI_ONCHIP_DA16XXX_SOCKET_STATUS_BOUND,
    WIFI_ONCHIP_DA16XXX_SOCKET_STATUS_LISTEN,
    WIFI_ONCHIP_DA16XXX_SOCKET_STATUS_CONNECTED
} da16xxx_socket_status_t;

/** DA16XXX socket shutdown channels */
typedef enum e_da16xxx_socket_rw
{
    WIFI_ONCHIP_DA16XXX_SOCKET_READ  = 1,
    WIFI_ONCHIP_DA16XXX_SOCKET_WRITE = 2
} da16xxx_socket_rw;

/** DA16XXX socket receive state */
typedef enum e_da16xxx_recv_state
{
    WIFI_ONCHIP_DA16XXX_RECV_PREFIX,     // +
    WIFI_ONCHIP_DA16XXX_RECV_CMD,        // command
    WIFI_ONCHIP_DA16XXX_RECV_SUFFIX,     // :
    WIFI_ONCHIP_DA16XXX_RECV_PARAM_CID,  // cid parameter
    WIFI_ONCHIP_DA16XXX_RECV_PARAM_IP,   // ip parameter
    WIFI_ONCHIP_DA16XXX_RECV_PARAM_PORT, // port parameter
    WIFI_ONCHIP_DA16XXX_RECV_PARAM_LEN,  // length parameter
    WIFI_ONCHIP_DA16XXX_RECV_DATA
} da16xxx_recv_state;

/** DA16XXX WiFi module enable/disable for SNTP Daylight */
typedef enum e_wifi_onchip_da16xxx_sntp_daylight_savings_enable
{
    WIFI_ONCHIP_DA16XXX_SNTP_DAYLIGHT_SAVINGS_DISABLE = 0,
    WIFI_ONCHIP_DA16XXX_SNTP_DAYLIGHT_SAVINGS_ENABLE  = 1,
} wifi_onchip_da16xxx_sntp_daylight_savings_enable_t;
...
typedef struct st_wifi_onchip_cfg
{
    ...
    const uart_instance_t * uart_instances[WIFI_ONCHIP_DA16XXX_CFG_MAX_NUMBER_UART_PORTS]; ///< SCI UART instances
...
typedef struct
{
    ...
    uint8_t              socket_recv_buff[WIFI_ONCHIP_DA16XXX_CFG_MAX_SOCKET_RX_SIZE]; ///< Socket receive buffer used by byte queue
} da16xxx_socket_t;

/** WIFI_ONCHIP_DA16XXX private control block. DO NOT MODIFY. */
typedef struct st_wifi_onchip_da16xxx_instance_ctrl
{
    wifi_onchip_da16xxx_cfg_t const * p_wifi_onchip_da16xxx_cfg;                            ///< Pointer to initial configurations.
    ...
    uint8_t              cmd_rx_queue_buf[WIFI_ONCHIP_DA16XXX_CFG_CMD_RX_BUF_SIZE];         ///< Command port receive buffer used by byte queue                                           // FreeRTOS
    StreamBufferHandle_t socket_byteq_hdl;                                                  ///< Socket stream buffer handle
    StaticStreamBuffer_t socket_byteq_struct;                                               ///< Structure to hold stream buffer info

    volatile uint32_t curr_socket_index;                                                    ///< Currently active socket instance
    uint8_t         * p_current_cmd_rx_buffer;                                              ///< Pointer to temporary receive buffer for dependent modules
    uint32_t          current_cmd_rx_buffer_size;                                           ///< Size of the temporary buffer
    uint8_t           cmd_tx_buff[WIFI_ONCHIP_DA16XXX_CFG_CMD_TX_BUF_SIZE];                 ///< Command send buffer
    uint8_t           cmd_rx_buff[WIFI_ONCHIP_DA16XXX_CFG_CMD_RX_BUF_SIZE];                 ///< Command receive buffer
    ...
    uart_instance_t * uart_instance_objects[WIFI_ONCHIP_DA16XXX_CFG_MAX_NUMBER_UART_PORTS]; ///< UART instance object
    SemaphoreHandle_t uart_tei_sem[WIFI_ONCHIP_DA16XXX_CFG_MAX_NUMBER_UART_PORTS];          ///< UART transmission end binary semaphore
    da16xxx_socket_t  sockets[WIFI_ONCHIP_DA16XXX_CFG_NUM_CREATEABLE_SOCKETS];              ///< Internal socket instances
...
extern const wifi_onchip_da16xxx_cfg_t g_wifi_onchip_da16xxx_cfg;
extern const char * g_wifi_onchip_da16xxx_uart_cmd_baud;
 ...
 *
 *************************************************************************************************************************************/
fsp_err_t RM_WIFI_ONCHIP_DA16XXX_SntpTimeZoneSet(int                                                utc_offset_in_hours,
                                                 uint32_t                                           minutes,
...
#endif                                 // RM_WIFI_ONCHIP_DA16XXX_H
