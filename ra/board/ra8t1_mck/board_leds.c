...
/*******************************************************************************************************************//**
 * @addtogroup BOARD_RA8T1_MCK_LEDS
 *
 * @{
 **********************************************************************************************************************/
...
{
    (uint16_t) BSP_IO_PORT_10_PIN_12,  ///< LED1
    (uint16_t) BSP_IO_PORT_10_PIN_14,  ///< LED2
    (uint16_t) BSP_IO_PORT_06_PIN_06,  ///< LED3
    (uint16_t) BSP_IO_PORT_10_PIN_06,  ///< LED4
};
...
/** @} (end addtogroup BOARD_RA8T1_MCK_LEDS) */
