...
/*******************************************************************************************************************//**
 * @ingroup BOARD_RA8E2_EK
 * @defgroup BOARD_RA8E2_EK_LEDS Board LEDs
 * @brief LED information for this board.
 *
 * This is code specific to the EK board. It includes info on the number of LEDs and which pins they are on.
 *
 * @{
 **********************************************************************************************************************/
...
/** @} (end defgroup BOARD_RA8E2_EK_LEDS) */
