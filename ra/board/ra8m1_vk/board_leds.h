...
/*******************************************************************************************************************//**
 * @ingroup BOARD_RA8M1_VK
 * @defgroup BOARD_RA8M1_VK_LEDS Board LEDs
 * @brief LED information for this board.
 *
 * This is code specific to the VK board. It includes info on the number of LEDs and which pins they are on.
 *
 * @{
 **********************************************************************************************************************/
...
/** @} (end defgroup BOARD_RA8M1_VK_LEDS) */
