...
/*******************************************************************************************************************//**
 * @addtogroup BOARD_RA6M3G_EK_LEDS
 *
 * @{
 **********************************************************************************************************************/
...
{
    (uint16_t) BSP_IO_PORT_04_PIN_03,  ///< LED1_B
    (uint16_t) BSP_IO_PORT_04_PIN_00,  ///< LED2_G
    (uint16_t) BSP_IO_PORT_01_PIN_00,  ///< LED3_R
};
...
/** @} (end addtogroup BOARD_RA6M3G_EK_LEDS) */
