...
/*******************************************************************************************************************//**
 * @addtogroup BSP_EK_RA6M3G_QSPI
 * @brief QSPI initialization
 *
 * This file contains code that initializes the QSPI flash controller connected to a MX25L12835F
 * Maxonic NOR Flash/ N25Q256A Micron Serial NOR Flash Memory mounted on a EK-RA6M3G evaluation board.
 * @{
 **********************************************************************************************************************/
...
/** @} (end addtogroup BSP_EK_RA6M3G_QSPI) */
