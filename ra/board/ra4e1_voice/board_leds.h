...
/*******************************************************************************************************************//**
 * @ingroup BOARD_RA4E1_VOICE
 * @defgroup BOARD_RA4E1_VOICE_LEDS Board LEDs
 * @brief LED information for this board.
 *
 * This is code specific to the VOICE board. It includes info on the number of LEDs and which pins they are on.
 *
 * @{
 **********************************************************************************************************************/
...
/** @} (end defgroup BOARD_RA4E1_VOICE_LEDS) */
