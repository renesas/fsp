...
/*******************************************************************************************************************//**
 * @addtogroup BOARD_RA2L1_RSSK_LEDS
 *
 * @{
 **********************************************************************************************************************/
...
{
    (uint16_t) BSP_IO_PORT_03_PIN_05,  ///< LED2
    (uint16_t) BSP_IO_PORT_03_PIN_04,  ///< LED3
};
...
/** @} (end addtogroup BOARD_RA2L1_RSSK_LEDS) */
