...
static D2_INLINE d2_u32 d2_bitpos_intern(d2_u32 v) /* PRQA S 3450, 3480, 3219 */ /* $Misra: #UTIL_INLINE_FUNC $*/
{
   d2_u32 r = 0; /* r will be lg(v) */

   if(0 == (v & 0xffffu)) /* unroll for more speed... */
   {
      v >>= 16;
      r = 16;
   }
